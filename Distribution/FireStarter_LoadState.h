...
// Run duration = 1001.304765 seconds
// Run generation = 64
// Run evolution = 19
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_copy_id = 35;
    state.m_test = 17;
    state.m_seed = 15436841550809334680;
    state.m_maxResult = 0.000027f;
