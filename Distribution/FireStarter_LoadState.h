...
// Run duration = 57.698589 seconds
// Run test = 12
// Run generation = 0
// Run evolution = 0
// Run precision  = 0.00000967
// Run max result = 0.00000433
...
{
    *(result->MaxResult()) = 0.00000433f;
    *(result->EvolveAge1()) = 2;
    *(result->EvolveAge2()) = 3;
    FireStarterData *data = result->Data();
    data->d[0] = 0.02807349f;
    data->d[1] = -0.79195774f;
    data->d[2] = 3.02120662f;
    data->d[3] = 1.13418031f;
    data->d[4] = 2.41150689f;
    data->d[5] = 2.41360760f;
    data->d[6] = 0.96011060f;
    data->d[7] = -0.12295653f;
    data->d[8] = 0.63796347f;
    data->d[9] = -2.15147662f;
    data->d[10] = 5.90801477f;
    data->d[11] = -1.86460912f;
    data->d[12] = -0.20307261f;
    data->d[13] = 2.10979819f;
    data->d[14] = -1.48155725f;
    data->d[15] = -4.77983379f;
    data->d[16] = 12.94797707f;
    data->d[17] = 0.10709797f;
    data->d[18] = -2.74422836f;
    data->d[19] = -0.78293782f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(30, (FireStarterOpcode)1, 6);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.00000433f;
