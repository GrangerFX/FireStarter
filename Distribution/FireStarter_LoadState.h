...
inline void LoadVariation0(FireStarterResult* result)
{
    ...
    *(result->EvolveAge1()) = 15;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = 2.08197379f;
    data->d[1] = -0.68101823f;
    data->d[2] = -1.96055424f;
    data->d[3] = 1.75560892f;
    data->d[4] = -1.81436992f;
    data->d[5] = -2.06476164f;
    data->d[6] = 2.29566288f;
    data->d[7] = -0.43438557f;
    data->d[8] = 0.10792721f;
    data->d[9] = -0.81216943f;
    data->d[10] = -1.43736124f;
    data->d[11] = -1.31725574f;
    data->d[12] = -1.10746992f;
    data->d[13] = 2.27727127f;
    data->d[14] = 2.33553267f;
    data->d[15] = 0.68526161f;
    data->d[16] = 0.00168058f;
    data->d[17] = 1.86179173f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(5, (FireStarterOpcode)1, 1);
    code->SetOperation(6, (FireStarterOpcode)0, 4);
    code->SetOperation(7, (FireStarterOpcode)0, 5);
    code->SetOperation(8, (FireStarterOpcode)1, 3);
    ...
    code->SetOperation(15, (FireStarterOpcode)1, 10);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 0;
    state.m_test = 19;
    state.m_seed = 12123004812672471707;
    state.m_optimize_pass = 0;
    state.m_bestResult = 0.00000000f;
