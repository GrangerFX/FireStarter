...
// Run duration = 1183.014662 seconds
// Run generation = 90
// Run evolution = 17
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_children0 = 90;
    state.m_children1 = 24;
    state.m_index = 12;
    state.m_copy_index = 12;
    state.m_id = 12;
    state.m_test = 0;
    state.m_seed = 9349612586538574170;
    state.m_optimize_pass =2;
    state.m_oldResult = 0.000001f;
    state.m_maxResult = 0.000000f;
    state.m_evolveWeight = 90.000000f;
