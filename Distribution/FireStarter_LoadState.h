...
// Run duration = 141.431222 seconds
// Run generation = 46
// Run evolution = 6
...
{
    *(result->MaxResult()) = 0.00000311f;
    *(result->EvolveAge1()) = 2;
    *(result->EvolveAge2()) = 5;
    FireStarterData *data = result->Data();
    data->d[0] = -0.25188217f;
    data->d[1] = -1.47898912f;
    data->d[2] = -1.28075397f;
    data->d[3] = 0.16112424f;
    data->d[4] = 0.38189864f;
    data->d[5] = 0.73249888f;
    data->d[6] = -0.96377468f;
    data->d[7] = 2.44081426f;
    data->d[8] = -0.13210857f;
    data->d[9] = -1.84908676f;
    data->d[10] = 0.06745535f;
    data->d[11] = 1.22174489f;
    data->d[12] = 1.57911325f;
    data->d[13] = -1.45996177f;
    data->d[14] = -0.73238158f;
    data->d[15] = 0.06824604f;
    data->d[16] = -1.64411366f;
    data->d[17] = -0.47030914f;
    data->d[18] = 0.28555781f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 16;
    state.m_test = 0;
    state.m_seed = 2076037727381059254;
    state.m_optimize_pass = 0;
    state.m_oldResult = 0.00000519f;
    state.m_evolveWeight = 0.000234f;
