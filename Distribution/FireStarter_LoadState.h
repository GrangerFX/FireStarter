...
inline void LoadProgram(FireStarterProgram& program)
{
    ...
    program.m_registers[7] = {7, 2, 7, 30};
    program.m_registers[8] = {8, 3, 8, 25};
    program.m_registers[9] = {9, 9, 9, 9};
    program.m_registers[10] = {10, 10, 10, 10};
    program.m_registers[11] = {11, 4, 11, 22};
    program.m_registers[12] = {12, 0, 15, 16};
    program.m_registers[13] = {13, 13, 17, 17};
    program.m_registers[14] = {14, 14, 18, 18};
    program.m_registers[15] = {15, 0, 19, 24};
    program.m_registers[16] = {16, 16, 20, 20};
    program.m_registers[17] = {17, 5, 21, 29};
...
inline void LoadResult(FireStarterState& state)
{
    ...
    state.Result()->maxResult = 0.044109f;
} // LoadResult

inline void LoadState(FireStarterState& state)
{
    state.m_generation = 120;
    state.m_seed = 3232319974;
