...
inline void LoadProgram(FireStarterProgram& program)
{
    ...
    program.m_registers[2] = {2, 0, 2, 18};
    program.m_registers[3] = {3, 1, 3, 21};
    program.m_registers[4] = {4, 2, 4, 29};
    program.m_registers[5] = {5, 3, 5, 23};
    program.m_registers[6] = {6, 4, 6, 27};
    program.m_registers[7] = {7, 5, 7, 11};
    program.m_registers[8] = {8, 8, 9, 9};
    program.m_registers[9] = {9, 6, 10, 25};
    program.m_registers[10] = {10, 5, 12, 13};
    program.m_registers[11] = {11, 11, 15, 15};
    program.m_registers[12] = {12, 5, 16, 31};
    program.m_registers[13] = {13, 0, 20, 28};
...
inline void LoadResult(FireStarterState& state)
{
    ...
    state.Result()->maxResult = 0.167340f;
} // LoadResult
