...
// Run date: 09/20/26 14:09:32 Pacific Daylight Time
// Run duration = 21.763860 seconds
// Run test = 2
// Run generation = 1
// Run evolution = 0
// Run precision  = 0.00001828
// Run max result = 0.00001236
...
{
    *(result->MaxResult()) = 0.00001236f;
    *(result->EvolveAge1()) = 3;
    *(result->EvolveAge2()) = 11;
    FireStarterData *data = result->Data();
    data->d[0] = -3.14159250f;
    data->d[1] = -0.05912744f;
    data->d[2] = -0.75856358f;
    data->d[3] = 0.24973817f;
    data->d[4] = -0.42958242f;
    data->d[5] = -0.32742959f;
    data->d[6] = -0.36030656f;
    data->d[7] = -2.04244828f;
    data->d[8] = 0.44685739f;
    data->d[9] = -3.38999581f;
    data->d[10] = -13.60733795f;
    data->d[11] = 1.81240284f;
    data->d[12] = 1.91493058f;
    data->d[13] = -1.86554444f;
    data->d[14] = 0.70108134f;
    data->d[15] = 0.71587867f;
    data->d[16] = 2.19419432f;
    data->d[17] = -0.99186546f;
    data->d[18] = -0.52571702f;
    data->d[19] = -1.69945192f;
    data->d[20] = -0.24227454f;
    data->d[21] = 1.59319913f;
    data->d[22] = 1.98118711f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.00001236f;
