...
// Run date: 09/01/26 17:30:18 Pacific Daylight Time
// Run duration = 14.008065 seconds
// Run test = 2
// Run generation = 5
// Run evolution = 0
// Run precision  = 0.00000694
// Run max result = 0.00000441
...
{
    *(result->MaxResult()) = 0.00000441f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 1;
    FireStarterData *data = result->Data();
    data->d[0] = 0.35747120f;
    data->d[1] = -1.12302887f;
    data->d[2] = -1.42503166f;
    data->d[3] = -1.90481853f;
    data->d[4] = 9.52647209f;
    data->d[5] = -1.07347298f;
    data->d[6] = -0.55694175f;
    data->d[7] = -17.47807312f;
    data->d[8] = -0.36286119f;
    data->d[9] = -0.01830038f;
    data->d[10] = -2.24127388f;
    data->d[11] = 0.39410925f;
    data->d[12] = -0.32179022f;
    data->d[13] = -1.48404968f;
    data->d[14] = -0.33719814f;
    data->d[15] = 3.35556555f;
    data->d[16] = 1.15851963f;
    data->d[17] = 0.59990638f;
    data->d[18] = -0.20113434f;
    data->d[19] = 2.48900795f;
    data->d[20] = -0.44192916f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.00000441f;
