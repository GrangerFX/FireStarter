...
// Run duration = 21.832314 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
...
inline void LoadVariation0(FireStarterResult* result)
{
    ...
    *(result->EvolveAge2()) = 0;
    ...
    data->d[0] = 1.34557033f;
    data->d[1] = -4.22572708f;
    data->d[2] = -0.00933953f;
    data->d[3] = -0.40938443f;
    data->d[4] = 1.80307138f;
    data->d[5] = -2.22621727f;
    data->d[6] = 2.25224757f;
    data->d[7] = 0.23829183f;
    data->d[8] = 1.92793059f;
    data->d[9] = -1.59712052f;
    data->d[10] = 1.52286875f;
    data->d[11] = 1.68796265f;
    data->d[12] = -1.34821439f;
    data->d[13] = 0.42179543f;
    data->d[14] = -1.11275744f;
    data->d[15] = 0.75338411f;
    data->d[16] = 0.90444613f;
    data->d[17] = 0.97176278f;
    data->d[18] = -0.27418113f;
    data->d[19] = -0.23088685f;
    data->d[20] = -0.52996445f;
