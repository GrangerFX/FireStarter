...
// Run date: 07/19/25 11:21:44 Pacific Daylight Time
// Run duration = 2.050339 seconds
// Run test = 0
// Run generation = 0
// Run evolution = 0
// Run precision  = 0.69663280
// Run max result = 0.30334824
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
inline void LoadVariation0(FireStarterResult* result)
{
    ...
    *(result->EvolveAge2()) = 0;
    ...
    data->d[6] = -0.47610250f;
    data->d[7] = -457.64923096f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.30334824f;
