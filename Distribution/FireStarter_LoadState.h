...
inline void LoadProgram(FireStarterProgram& program)
{
    ...
    program.m_registers[5] = {5, 2, 6, 17};
    program.m_registers[6] = {6, 3, 7, 25};
    program.m_registers[7] = {7, 4, 8, 21};
    program.m_registers[8] = {8, 8, 10, 10};
    program.m_registers[9] = {9, 9, 11, 11};
    program.m_registers[10] = {10, 10, 12, 12};
    program.m_registers[11] = {11, 0, 13, 15};
...
inline void LoadResult(FireStarterState& state)
{
    ...
    state.Result()->maxResult = 0.000108f;
} // LoadResult

inline void LoadState(FireStarterState& state)
{
    state.m_generation = 1693;
    state.m_seed = 2057;
