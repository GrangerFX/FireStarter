...
// Run date: 10/18/25 11:56:39 Pacific Daylight Time
// Run duration = 53.800268 seconds
// Run test = 0
// Run generation = 2
// Run evolution = 0
// Run precision  = 8.89472580
// Run max result = 0.44436869
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
{
    *(result->MaxResult()) = 0.44436869f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 81;
    FireStarterData *data = result->Data();
    data->d[0] = -0.36897522f;
    data->d[1] = -0.63536096f;
    data->d[2] = 0.23628274f;
    data->d[3] = -1.09594834f;
    data->d[4] = -0.95297462f;
    data->d[5] = -0.30359873f;
    data->d[6] = -2.36551094f;
    data->d[7] = -0.57265723f;
    data->d[8] = 2.37179804f;
    data->d[9] = -0.14565767f;
    data->d[10] = -0.74373281f;
    data->d[11] = 0.87229669f;
    data->d[12] = -2.38959956f;
    data->d[13] = -1.03447652f;
    data->d[14] = 1.58027768f;
    data->d[15] = -0.42830917f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(17, (FireStarterOpcode)2, 1);
    ...
    code->SetOperation(22, (FireStarterOpcode)0, 3);
    code->SetOperation(23, (FireStarterOpcode)2, 4);
    code->SetOperation(24, (FireStarterOpcode)2, 14);
    code->SetOperation(25, (FireStarterOpcode)1, 0);
    code->SetOperation(26, (FireStarterOpcode)2, 5);
    code->SetOperation(27, (FireStarterOpcode)2, 7);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.44436869f;
