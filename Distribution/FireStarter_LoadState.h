...
// Run date: 04/20/25 11:57:44 Pacific Daylight Time
// Run duration = 47.837384 seconds
// Run generation = 6
// Run evolution = 2
// Run max result = 0.00000931
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
{
    *(result->MaxResult()) = 0.00000931f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 3;
    FireStarterData *data = result->Data();
    data->d[0] = 0.03144083f;
    data->d[1] = 2.15785170f;
    data->d[2] = -4.03014374f;
    data->d[3] = -1.29915380f;
    data->d[4] = -1.41635168f;
    data->d[5] = -1.46227241f;
    data->d[6] = -0.51610374f;
    data->d[7] = -1.37726843f;
    data->d[8] = -0.65408665f;
    data->d[9] = 8.58002377f;
    data->d[10] = 0.24961455f;
    data->d[11] = -0.06178535f;
    data->d[12] = -0.46082836f;
    data->d[13] = 2.15717363f;
    data->d[14] = 2.34522867f;
    data->d[15] = -0.60634398f;
    data->d[16] = 2.19522786f;
    data->d[17] = -0.19770971f;
    data->d[18] = 1.51626027f;
    data->d[19] = 0.80411136f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(9, (FireStarterOpcode)1, 3);
    ...
    code->SetOperation(20, (FireStarterOpcode)0, 5);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 2;
    state.m_test = 0;
    state.m_seed = 17985845555105077140;
    state.m_optimize_pass = 0;
    state.m_oldResult = 0.00005602f;
    state.m_evolveWeight = 0.000280f;
