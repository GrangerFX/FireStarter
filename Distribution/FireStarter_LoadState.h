...
// Run duration = 1134.641648 seconds
// Run generation = 85
// Run evolution = 0
// Run result = 0.00016509
// Run variations = 3
// Run samples = 15
// Run instructions = 32
// Run registers = 29
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_index = 7;
    state.m_test = 0;
    state.m_seed = 11422290555971698826;
} // LoadState
