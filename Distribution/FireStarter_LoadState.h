...
// Run duration = 765.723896 seconds
// Run generation = 330
// Run evolution = 9
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_generation = 330;
    state.m_evolution = 9;
    state.m_index = 3;
    state.m_copy_index = 48;
    state.m_id = 48;
    state.m_test = 0;
    state.m_seed = 13069609894079921742;
    state.m_optimize_pass =0;
    state.m_oldResult = 0.000001f;
    state.m_maxResult = 0.000001f;
    state.m_evolveWeight = 0.000264f;
