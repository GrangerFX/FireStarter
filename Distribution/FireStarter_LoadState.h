...
// Run date: 06/25/24 10:17:02 Pacific Daylight Time
// Run duration = 76.117460 seconds
// Run generation = 36
// Run evolution = 3
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 9;
    state.m_test = 0;
    state.m_seed = 5046330937562783901;
    state.m_optimize_pass =0;
    state.m_oldResult = 0.000061f;
    state.m_maxResult = 0.000026f;
    state.m_evolveWeight = 0.001719f;
