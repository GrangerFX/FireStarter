...
// Run duration = 34.696202 seconds
// Run test = 7
// Run generation = 4
// Run evolution = 0
// Run precision  = 0.00000799
// Run max result = 0.00000119
...
{
    *(result->MaxResult()) = 0.00000119f;
    *(result->EvolveAge1()) = 2;
    *(result->EvolveAge2()) = 6;
    FireStarterData *data = result->Data();
    data->d[0] = -3.14159274f;
    data->d[1] = -6.76645851f;
    data->d[2] = -2.04534602f;
    data->d[3] = -0.02583588f;
    data->d[4] = -1.14917743f;
    data->d[5] = -2.98095918f;
    data->d[6] = 1.79369652f;
    data->d[7] = -1.79995883f;
    data->d[8] = 0.55972308f;
    data->d[9] = -0.25401196f;
    data->d[10] = -2.55894399f;
    data->d[11] = -0.18173501f;
    data->d[12] = 5.49235916f;
    data->d[13] = -2.45285845f;
    data->d[14] = 0.00000000f;
    data->d[15] = 1.58180666f;
    data->d[16] = -0.11841772f;
    data->d[17] = 0.51694083f;
    data->d[18] = -0.53787714f;
    data->d[19] = -0.05054805f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 0;
    state.m_test = 7;
    state.m_seed = 4112332090098729659;
    state.m_optimize_pass = 0;
    state.m_bestResult = 0.00000119f;
    state.m_oldResult = 0.00000248f;
