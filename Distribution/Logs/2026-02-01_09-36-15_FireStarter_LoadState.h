...
// Run date: 02/01/26 09:36:15 Pacific Standard Time
// Run duration = 827.768677 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.98933858
...
{
    *(result->MaxResult()) = 0.98933858f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = 0.44328582f;
    data->d[1] = 0.64149344f;
    data->d[2] = 0.24457914f;
    data->d[3] = -0.82783777f;
    data->d[4] = 0.44615170f;
    data->d[5] = -0.58536500f;
    data->d[6] = -0.50867754f;
    data->d[7] = 0.39833978f;
    data->d[8] = -0.75657374f;
    data->d[9] = 0.83678645f;
    data->d[10] = -0.95479375f;
    data->d[11] = -0.33591303f;
    data->d[12] = 0.15408552f;
    data->d[13] = -0.66452593f;
    data->d[14] = 0.96676338f;
    data->d[15] = -0.95266366f;
    data->d[16] = 0.60910499f;
    data->d[17] = 0.69556862f;
    data->d[18] = -0.67027181f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(20, (FireStarterOpcode)2, 2);
    code->SetOperation(21, (FireStarterOpcode)2, 10);
    code->SetOperation(22, (FireStarterOpcode)0, 11);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.98933858f;
