...
// Run date: 10/27/24 10:42:08 Pacific Daylight Time
// Run duration = 148.697547 seconds
// Run generation = 5
// Run evolution = 0
...
inline void LoadVariation0(FireStarterResult* result)
{
    ...
    data->d[0] = -0.64849550f;
    data->d[1] = -0.76638168f;
    data->d[2] = -1.56135607f;
    data->d[3] = -0.59724748f;
    data->d[4] = 1.19778311f;
    data->d[5] = -0.74440837f;
    data->d[6] = 0.05611632f;
    data->d[7] = 1.11767149f;
    data->d[8] = -0.02034757f;
    data->d[9] = -0.04426225f;
    data->d[10] = 5.19388819f;
    data->d[11] = 2.20533824f;
    data->d[12] = 1.02875388f;
    data->d[13] = -1.26551676f;
    data->d[14] = 1.81039023f;
    data->d[15] = -2.36078119f;
    data->d[16] = -5.49931765f;
    data->d[17] = 0.17606556f;
    data->d[18] = -1.84146929f;
    data->d[19] = 1.74426460f;
    data->d[20] = 0.32752195f;
    data->d[21] = -1.92559278f;
    data->d[22] = 0.65439212f;
    data->d[23] = -0.43846151f;
    data->d[24] = 1.00641048f;
    data->d[25] = 1.56949365f;
    data->d[26] = -0.71302480f;
    data->d[27] = -1.32046998f;
    data->d[28] = -1.03592372f;
    data->d[29] = -0.90026951f;
    *(result->MinResult()) = 0.00000030f;
} // LoadVariation0

inline void LoadResult(FireStarterState& state)
{
    LoadVariation0(state.Result(0));
    state.m_maxResult = 0.00000030f;
} // LoadResult
