...
// Run date: 02/16/26 09:09:50 Pacific Standard Time
// Run duration = 1145.831993 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.99826056
...
{
    *(result->MaxResult()) = 0.99826056f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.82699776f;
    data->d[1] = -0.31078932f;
    data->d[2] = -0.94101906f;
    data->d[3] = 0.39344573f;
    data->d[4] = 0.75442249f;
    data->d[5] = -0.73056602f;
    data->d[6] = 0.30120957f;
    data->d[7] = -0.73688775f;
    data->d[8] = 0.63293463f;
    data->d[9] = 0.21786505f;
    data->d[10] = 0.56313372f;
    data->d[11] = 0.79180813f;
    data->d[12] = 0.74066132f;
    data->d[13] = 0.56979036f;
    data->d[14] = -0.80090278f;
    data->d[15] = -0.12829261f;
    data->d[16] = 0.87141085f;
    data->d[17] = 0.72378629f;
    data->d[18] = 0.64460844f;
    data->d[19] = 0.01834571f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(5, (FireStarterOpcode)1, 2);
    code->SetOperation(6, (FireStarterOpcode)2, 5);
    code->SetOperation(7, (FireStarterOpcode)0, 0);
    ...
    code->SetOperation(12, (FireStarterOpcode)1, 0);
    ...
    code->SetOperation(25, (FireStarterOpcode)2, 6);
    code->SetOperation(26, (FireStarterOpcode)0, 2);
    code->SetOperation(27, (FireStarterOpcode)2, 6);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.99826056f;
