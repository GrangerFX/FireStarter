...
// Run date: 10/26/25 10:59:15 Pacific Daylight Time
// Run duration = 1703.868522 seconds
// Run test = 0
// Run generation = 10
// Run evolution = 0
// Run precision  = 10.00000000
// Run max result = 0.55804062
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
{
    *(result->MaxResult()) = 0.55804062f;
    *(result->EvolveAge1()) = 2;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = 0.09914011f;
    data->d[1] = -1.21127105f;
    data->d[2] = -0.32202268f;
    data->d[3] = 1.04443216f;
    data->d[4] = -2.09641767f;
    data->d[5] = 0.58302408f;
    data->d[6] = 0.41470245f;
    data->d[7] = 1.35005438f;
    data->d[8] = -1.36307466f;
    data->d[9] = -1.17957580f;
    data->d[10] = 1.62082839f;
    data->d[11] = 1.26251245f;
    data->d[12] = -0.79637694f;
    data->d[13] = -2.49001598f;
    data->d[14] = 0.25931814f;
    data->d[15] = 1.29431474f;
    data->d[16] = -1.20246136f;
    data->d[17] = -1.31469965f;
    data->d[18] = 2.25207520f;
    data->d[19] = 0.24058579f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(14, (FireStarterOpcode)1, 6);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.55804062f;
