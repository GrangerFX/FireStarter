...
#define MONEYMAKER_HISTORY          (1 + MONEYMAKER_WARMUP + MONEYMAKER_TRADING)   // Days of stock history data
#define MONEYMAKER_STOCKS           1           // Stocks with history data
#define MONEYMAKER_FUNDS            1000.0f     // Starting trading funds
#define MONEYMAKER_RANDOM           0           // Set to 1 to trade using random coin flips for comparison
