...
// Run date: 10/19/25 11:41:17 Pacific Daylight Time
// Run duration = 7023.253381 seconds
// Run test = 0
// Run generation = 471
// Run evolution = 0
// Run precision  = 1.15001714
// Run max result = 0.40410766
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
{
    *(result->MaxResult()) = 0.40410766f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 123;
    FireStarterData *data = result->Data();
    data->d[0] = 2.41147518f;
    data->d[1] = 0.45793620f;
    data->d[2] = 0.49752527f;
    data->d[3] = -0.45597354f;
    data->d[4] = -1.24638629f;
    data->d[5] = 0.04995033f;
    data->d[6] = 0.07716502f;
    data->d[7] = -0.23651001f;
    data->d[8] = 1.28426242f;
    data->d[9] = -1.63826382f;
    data->d[10] = -1.74984980f;
    data->d[11] = -1.81446910f;
    data->d[12] = 0.61837733f;
    data->d[13] = 0.40830058f;
    data->d[14] = -1.97030723f;
    data->d[15] = -1.21490562f;
    data->d[16] = 1.22589386f;
    data->d[17] = -1.87372398f;
    data->d[18] = 0.95291322f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(6, (FireStarterOpcode)2, 0);
    ...
    code->SetOperation(15, (FireStarterOpcode)2, 5);
    code->SetOperation(16, (FireStarterOpcode)2, 10);
    ...
    code->SetOperation(23, (FireStarterOpcode)2, 15);
    code->SetOperation(24, (FireStarterOpcode)2, 15);
    ...
    code->SetOperation(29, (FireStarterOpcode)2, 17);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_generation = 471;
    state.m_evolution = 0;
    state.m_index = 0;
    state.m_evolveIndex = 0;
    state.m_id = 0;
    state.m_test = 0;
    state.m_seed = 2244390582287122933;
    state.m_optimize_pass = 0;
    state.m_bestResult = 0.40410766f;
