...
#define FIRESTARTER_OPTIMIZATION_SEED 0 // Set the optimization seed or comment out use the main seed.
...
#define FIRESTARTER_EVOLVE_MODE_CROSSOVER_FIRST  2
#define FIRESTARTER_EVOLVE_MODE_CROSSOVER_LAST   3
