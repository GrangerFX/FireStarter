...
// Run date: 01/24/26 12:51:40 Pacific Standard Time
// Run duration = 2109.797234 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.44876310
...
{
    *(result->MaxResult()) = 0.44876310f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.47726506f;
    data->d[1] = 0.19214070f;
    data->d[2] = 0.43874019f;
    data->d[3] = -0.02151386f;
    data->d[4] = -0.74518520f;
    data->d[5] = -0.79009795f;
    data->d[6] = -0.08914358f;
    data->d[7] = -0.86677372f;
    data->d[8] = -0.50378609f;
    data->d[9] = 0.48528174f;
    data->d[10] = -1.91211915f;
    data->d[11] = -0.91445017f;
    data->d[12] = 0.55649298f;
    data->d[13] = 2.10408974f;
    data->d[14] = -0.46570170f;
    data->d[15] = -2.27635908f;
    data->d[16] = 0.31303394f;
    data->d[17] = -0.27578554f;
    data->d[18] = 0.34035143f;
    data->d[19] = -0.12517671f;
    data->d[20] = 1.15059614f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(19, (FireStarterOpcode)2, 7);
    ...
    code->SetOperation(26, (FireStarterOpcode)2, 4);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.44876310f;
