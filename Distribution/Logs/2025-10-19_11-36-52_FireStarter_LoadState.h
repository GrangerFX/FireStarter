...
// Run date: 10/19/25 11:36:52 Pacific Daylight Time
// Run duration = 49.968770 seconds
// Run test = 0
// Run generation = 3
// Run evolution = 0
// Run precision  = 10.00000000
// Run max result = 0.44991854
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
{
    *(result->MaxResult()) = 0.44991854f;
    *(result->EvolveAge1()) = 2;
    *(result->EvolveAge2()) = 172;
    FireStarterData *data = result->Data();
    data->d[0] = 1.59195316f;
    data->d[1] = -1.93993473f;
    data->d[2] = 2.06063342f;
    data->d[3] = -1.17351532f;
    data->d[4] = -2.11164761f;
    data->d[5] = 0.06184453f;
    data->d[6] = -0.84636480f;
    data->d[7] = -1.53124261f;
    data->d[8] = -0.46048120f;
    data->d[9] = -0.29482761f;
    data->d[10] = -2.38317990f;
    data->d[11] = -2.47350407f;
    data->d[12] = -1.58835995f;
    data->d[13] = -3.19407606f;
    data->d[14] = -0.83285803f;
    data->d[15] = 0.57105076f;
    data->d[16] = -1.33831668f;
    data->d[17] = -0.15470970f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(11, (FireStarterOpcode)2, 4);
    ...
    code->SetOperation(16, (FireStarterOpcode)1, 7);
    ...
    code->SetOperation(20, (FireStarterOpcode)2, 11);
    ...
    code->SetOperation(30, (FireStarterOpcode)1, 2);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.44991854f;
