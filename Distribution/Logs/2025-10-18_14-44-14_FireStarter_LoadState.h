...
// Run date: 10/18/25 14:44:14 Pacific Daylight Time
// Run duration = 669.098979 seconds
// Run test = 0
// Run generation = 9
// Run evolution = 0
// Run precision  = 10.00000000
// Run max result = 0.41314498
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
{
    *(result->MaxResult()) = 0.41314498f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 111;
    FireStarterData *data = result->Data();
    data->d[0] = -0.45506024f;
    data->d[1] = -1.09584796f;
    data->d[2] = 2.17940855f;
    data->d[3] = 0.86324281f;
    data->d[4] = 0.50967455f;
    data->d[5] = -0.45446694f;
    data->d[6] = -1.78013301f;
    data->d[7] = 2.00733542f;
    data->d[8] = -0.66506529f;
    data->d[9] = -0.55549759f;
    data->d[10] = -1.53598821f;
    data->d[11] = -1.41200292f;
    data->d[12] = -0.16483435f;
    data->d[13] = -2.30074358f;
    data->d[14] = 0.84302402f;
    data->d[15] = -0.99812400f;
    data->d[16] = 1.98433495f;
    data->d[17] = -0.17038578f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(15, (FireStarterOpcode)2, 10);
    code->SetOperation(16, (FireStarterOpcode)1, 0);
    code->SetOperation(17, (FireStarterOpcode)2, 7);
    code->SetOperation(18, (FireStarterOpcode)1, 12);
    code->SetOperation(19, (FireStarterOpcode)1, 4);
    ...
    code->SetOperation(30, (FireStarterOpcode)2, 8);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.41314498f;
