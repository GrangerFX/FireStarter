...
// Run date: 09/19/26 11:59:05 Pacific Daylight Time
// Run duration = 89.417474 seconds
// Run test = 6
// Run generation = 4
// Run evolution = 1
// Run precision  = 0.00000593
...
{
    *(result->MaxResult()) = 0.00000027f;
    *(result->EvolveAge1()) = 2;
    *(result->EvolveAge2()) = 7;
    FireStarterData *data = result->Data();
    data->d[0] = -0.53772098f;
    data->d[1] = -0.14517039f;
    data->d[2] = -0.36785457f;
    data->d[3] = 2.17971849f;
    data->d[4] = -1.60675478f;
    data->d[5] = 3.40738273f;
    data->d[6] = 1.03382921f;
    data->d[7] = 0.08182281f;
    data->d[8] = 1.90830052f;
    data->d[9] = 10.75952148f;
    data->d[10] = 0.15555356f;
    data->d[11] = 0.11815935f;
    data->d[12] = 5.88435268f;
    data->d[13] = 1.19395792f;
    data->d[14] = -0.66258532f;
    data->d[15] = -0.15109421f;
    data->d[16] = -1.72539723f;
    data->d[17] = 0.64772034f;
    data->d[18] = -2.96560836f;
    data->d[19] = 0.59628880f;
    data->d[20] = 1.78374267f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 15;
    state.m_test = 6;
    state.m_seed = 5037997212997324844;
    state.m_optimize_pass = 0;
    state.m_bestResult = 0.00000027f;
    state.m_oldResult = 0.00000161f;
