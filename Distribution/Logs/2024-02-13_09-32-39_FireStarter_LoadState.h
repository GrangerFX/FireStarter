...
// Run duration = 16139.878810 seconds
// Run generation = 54
// Run evolution = 13
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_children0 = 13;
    state.m_children1 = 17;
    state.m_index = 0;
    state.m_copy_index = 0;
    state.m_id = 0;
    state.m_test = 255;
    state.m_seed = 385867671008475968;
    state.m_optimize_pass =8;
    state.m_oldResult = 0.000038f;
    state.m_maxResult = 0.000024f;
    state.m_evolveWeight = 1.349206f;
