...
// Run date: 09/28/25 14:43:57 Pacific Daylight Time
// Run duration = 372.943781 seconds
// Run test = 0
// Run generation = 32
// Run evolution = 0
// Run precision  = 10.00000000
// Run max result = 0.44108328
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
{
    *(result->MaxResult()) = 0.44108328f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 174;
    FireStarterData *data = result->Data();
    data->d[0] = 0.91729665f;
    data->d[1] = -0.53679645f;
    data->d[2] = -0.80875754f;
    data->d[3] = 0.91449374f;
    data->d[4] = -2.17359400f;
    data->d[5] = 1.64549208f;
    data->d[6] = 0.66131043f;
    data->d[7] = 2.46954489f;
    data->d[8] = 2.43647385f;
    data->d[9] = -0.68465227f;
    data->d[10] = 0.13330793f;
    data->d[11] = -0.83923447f;
    data->d[12] = -0.96632689f;
    data->d[13] = 0.76176417f;
    data->d[14] = 1.99867427f;
    data->d[15] = 0.45587569f;
    data->d[16] = -2.11603665f;
    data->d[17] = 1.44915116f;
    data->d[18] = -0.62778825f;
    data->d[19] = 0.31586713f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(21, (FireStarterOpcode)1, 4);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 0;
    state.m_test = 0;
    state.m_seed = 14643557974322127456;
    state.m_optimize_pass = 0;
    state.m_bestResult = 0.44108328f;
