...
// Run date: 12/01/24 12:15:44 Pacific Standard Time
// Run duration = 654.896377 seconds
// Run generation = 9
// Run evolution = 0
...
inline void LoadVariation0(FireStarterResult* result)
{
    ...
    data->d[0] = 0.34695441f;
    data->d[1] = -1.08998942f;
    data->d[2] = 0.24086191f;
    data->d[3] = -2.48934746f;
    data->d[4] = 3.34950566f;
    data->d[5] = 7.22090912f;
    data->d[6] = -2.38036537f;
    data->d[7] = 1.42435920f;
    data->d[8] = -1.52415442f;
    data->d[9] = 8.93646717f;
    data->d[10] = 3.39978743f;
    data->d[11] = -0.03811339f;
    data->d[12] = 0.53937775f;
    data->d[13] = 0.63107008f;
    data->d[14] = -17.39470482f;
    data->d[15] = 0.13192005f;
    data->d[16] = -9.43427467f;
    data->d[17] = -0.14475863f;
    data->d[18] = -3.13885021f;
    data->d[19] = 0.19881472f;
