...
// Run date: 11/15/25 11:47:11 Pacific Standard Time
// Run duration = 1775.518581 seconds
// Run test = 0
// Run generation = 8
// Run evolution = 0
// Run precision  = 10.00000000
// Run max result = 0.67808288
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
{
    *(result->MaxResult()) = 0.67808288f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.82255739f;
    data->d[1] = -2.30611539f;
    data->d[2] = 0.25512561f;
    data->d[3] = -2.40027761f;
    data->d[4] = 2.13332319f;
    data->d[5] = -1.01061869f;
    data->d[6] = -1.03930831f;
    data->d[7] = 1.00739145f;
    data->d[8] = -0.82753175f;
    data->d[9] = 0.67017621f;
    data->d[10] = -0.67240053f;
    data->d[11] = -0.74392343f;
    data->d[12] = 2.24731898f;
    data->d[13] = -0.45454445f;
    data->d[14] = -1.20846069f;
    data->d[15] = 1.91683578f;
    data->d[16] = 1.31937766f;
    data->d[17] = 2.25656223f;
    data->d[18] = -0.13342905f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.67808288f;
