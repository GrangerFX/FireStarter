...
// Run duration = 28870.244755 seconds
// Run generation = 107
// Run evolution = 9
...
inline void LoadVariation1(FireStarterResult* result)
{
    ...
    data->d[11] = 0.627171f;
    data->d[12] = 0.170955f;
    data->d[13] = 665.293579f;
    data->d[14] = -1.289995f;
    data->d[15] = 12.234707f;
    data->d[16] = -0.720408f;
    data->d[17] = 0.819352f;
    data->d[18] = -0.118132f;
    data->d[19] = 0.000000f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 3;
    state.m_test = 15;
    state.m_seed = 2499549055266078640;
    state.m_optimize_pass =4;
    state.m_oldResult = 0.000001f;
    state.m_maxResult = 0.000000f;
    state.m_evolveWeight = 7.000000f;
