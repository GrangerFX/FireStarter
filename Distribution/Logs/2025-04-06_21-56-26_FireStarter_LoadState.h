...
// Run duration = 3029.710768 seconds
// Run generation = 0
// Run evolution = 0
...
{
    *(result->MaxResult()) = 0.00005857f;
    *(result->EvolveAge1()) = 2;
    *(result->EvolveAge2()) = 3;
    FireStarterData *data = result->Data();
    data->d[0] = -0.15212685f;
    data->d[1] = -1.32458723f;
    data->d[2] = 0.95301211f;
    data->d[3] = -0.42114139f;
    data->d[4] = -3.05504251f;
    data->d[5] = -0.08086079f;
    data->d[6] = -10.20911407f;
    data->d[7] = -0.52667552f;
    data->d[8] = -0.06563309f;
    data->d[9] = -0.99077511f;
    data->d[10] = 1.56899428f;
    data->d[11] = 2.10164022f;
    data->d[12] = -4.69684839f;
    data->d[13] = -0.53213775f;
    data->d[14] = -0.09229688f;
    data->d[15] = 1.61970186f;
    data->d[16] = -0.62356389f;
    data->d[17] = 0.20461367f;
    data->d[18] = -0.94159991f;
    data->d[19] = -1.41088903f;
    data->d[20] = 1.13229990f;
    data->d[21] = 2.20984626f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(7, (FireStarterOpcode)1, 1);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 1;
    state.m_test = 64;
    state.m_seed = 9641169244865338475;
