...
// Run date: 01/25/26 16:03:02 Pacific Standard Time
// Run duration = 5055.746252 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
...
{
    *(result->MaxResult()) = 0.44176134f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.13737281f;
    data->d[1] = -0.12786625f;
    data->d[2] = -0.13342004f;
    data->d[3] = -0.83649182f;
    data->d[4] = 0.81395257f;
    data->d[5] = -0.54490775f;
    data->d[6] = 0.05466425f;
    data->d[7] = 0.99357867f;
    data->d[8] = -0.49835980f;
    data->d[9] = 0.56184435f;
    data->d[10] = -0.97374141f;
    data->d[11] = -0.27562049f;
    data->d[12] = 0.44130409f;
    data->d[13] = -0.36935189f;
    data->d[14] = 0.04442475f;
    data->d[15] = -0.43033594f;
    data->d[16] = 0.30532435f;
    data->d[17] = 0.19291252f;
    data->d[18] = -0.81118339f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(26, (FireStarterOpcode)2, 16);
    code->SetOperation(27, (FireStarterOpcode)2, 8);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.44176134f;
