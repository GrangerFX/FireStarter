...
// Run date: 09/19/26 11:43:52 Pacific Daylight Time
// Run duration = 19.305282 seconds
// Run test = 1
// Run generation = 0
// Run evolution = 0
// Run precision  = 0.00002700
// Run max result = 0.00000376
...
{
    *(result->MaxResult()) = 0.00000376f;
    *(result->EvolveAge1()) = 2;
    *(result->EvolveAge2()) = 10;
    FireStarterData *data = result->Data();
    data->d[0] = 0.35473168f;
    data->d[1] = -0.31463596f;
    data->d[2] = 0.39521855f;
    data->d[3] = -2.37212062f;
    data->d[4] = 0.10575429f;
    data->d[5] = 0.78843218f;
    data->d[6] = -1.10514152f;
    data->d[7] = 0.72473693f;
    data->d[8] = -1.37982988f;
    data->d[9] = 1.40841913f;
    data->d[10] = -0.64243394f;
    data->d[11] = 0.22408859f;
    data->d[12] = 1.08666003f;
    data->d[13] = 2.37502599f;
    data->d[14] = 0.00000356f;
    data->d[15] = 0.61779773f;
    data->d[16] = -6.68453884f;
    data->d[17] = 0.00001485f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(23, (FireStarterOpcode)1, 7);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 8;
    state.m_test = 1;
    state.m_seed = 7396984284380001265;
    state.m_optimize_pass = 0;
    state.m_bestResult = 0.00000376f;
    state.m_oldResult = 0.00003245f;
