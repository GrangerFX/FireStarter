...
// Run date: 11/27/25 10:42:06 Pacific Standard Time
// Run duration = 1938.178383 seconds
// Run test = 0
// Run generation = 2
// Run evolution = 0
// Run max result = 0.95726210
...
{
    *(result->MaxResult()) = 0.95726210f;
    *(result->EvolveAge1()) = 2;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -1.23189628f;
    data->d[1] = 1.18536651f;
    data->d[2] = -2.43930626f;
    data->d[3] = -2.49706125f;
    data->d[4] = 0.62520808f;
    data->d[5] = -1.44767869f;
    data->d[6] = 1.43617213f;
    data->d[7] = 0.32835725f;
    data->d[8] = 1.64887273f;
    data->d[9] = -0.53189868f;
    data->d[10] = -0.57677752f;
    data->d[11] = -0.87203491f;
    data->d[12] = -1.44129872f;
    data->d[13] = -0.08590416f;
    data->d[14] = 0.53424025f;
    data->d[15] = 0.35951841f;
    data->d[16] = -0.28286549f;
    data->d[17] = -1.48525643f;
    data->d[18] = 1.26756668f;
    data->d[19] = 1.77767563f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(3, (FireStarterOpcode)2, 0);
    code->SetOperation(4, (FireStarterOpcode)2, 2);
    code->SetOperation(5, (FireStarterOpcode)2, 3);
    ...
    code->SetOperation(9, (FireStarterOpcode)2, 2);
    ...
    code->SetOperation(24, (FireStarterOpcode)2, 16);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.95726210f;
