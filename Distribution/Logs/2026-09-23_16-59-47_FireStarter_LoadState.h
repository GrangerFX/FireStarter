...
// Run date: 09/23/26 16:59:47 Pacific Daylight Time
// Run duration = 119.120868 seconds
// Run test = 32
// Run generation = 2
// Run evolution = 0
// Run precision  = 0.00005323
// Run max result = 0.00000919
...
{
    *(result->MaxResult()) = 0.00000919f;
    *(result->EvolveAge()) = 2;
    FireStarterData *data = result->Data();
    data->d[0] = -0.22177570f;
    data->d[1] = 8.36380863f;
    data->d[2] = -7.66708183f;
    data->d[3] = -2.50975394f;
    data->d[4] = -1.47186220f;
    data->d[5] = -0.63238478f;
    data->d[6] = -0.00003250f;
    data->d[7] = 0.75749844f;
    data->d[8] = 1.16605544f;
    data->d[9] = 1.31725729f;
    data->d[10] = -1.54760683f;
    data->d[11] = -1.72077429f;
    data->d[12] = -1.48785710f;
    data->d[13] = 1.82247627f;
    data->d[14] = -1.60111499f;
    data->d[15] = -1.94496763f;
    data->d[16] = 0.80996215f;
    data->d[17] = 1.03576446f;
    data->d[18] = 0.92620689f;
    data->d[19] = -1.16743863f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 0;
    state.m_test = 32;
    state.m_seed = 11017301227203296582;
    state.m_optimize_pass = 0;
    state.m_bestResult = 0.00000919f;
    state.m_oldResult = 0.00048675f;
