...
// Run date: 11/15/25 12:55:43 Pacific Standard Time
// Run duration = 1768.845626 seconds
// Run test = 0
// Run generation = 6
// Run evolution = 0
// Run precision  = 10.00000000
// Run max result = 0.70332772
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
{
    *(result->MaxResult()) = 0.70332772f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.70969611f;
    data->d[1] = -0.33610526f;
    data->d[2] = -1.51454675f;
    data->d[3] = 2.25811362f;
    data->d[4] = 0.98873544f;
    data->d[5] = 1.14382732f;
    data->d[6] = -1.70064473f;
    data->d[7] = 8.09919262f;
    data->d[8] = 1.32033157f;
    data->d[9] = 0.95357895f;
    data->d[10] = -1.16119361f;
    data->d[11] = -4.93207169f;
    data->d[12] = 2.94794273f;
    data->d[13] = -12.10748386f;
    data->d[14] = -1.55572033f;
    data->d[15] = -0.58723146f;
    data->d[16] = 2.27636504f;
    data->d[17] = -2.29494119f;
    data->d[18] = 1.57914281f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.70332772f;
