...
// Run duration = 227.346203 seconds
// Run generation = 133
// Run evolution = 9
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_generation = 133;
    state.m_evolution = 9;
    state.m_index = 10;
    state.m_copy_index = 2;
    state.m_id = 2;
    state.m_test = 0;
    state.m_seed = 7113870910574567955;
    state.m_optimize_pass =4;
    state.m_oldResult = 0.000001f;
    state.m_maxResult = 0.000000f;
    state.m_evolveWeight = 0.000126f;
