...
// Run date: 12/14/25 09:39:24 Pacific Standard Time
// Run duration = 11.027185 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.81734365
...
{
    *(result->MaxResult()) = 0.81734365f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.25929570f;
    data->d[1] = -0.71046281f;
    data->d[2] = -0.03782865f;
    data->d[3] = 0.49995685f;
    data->d[4] = -0.74160177f;
    data->d[5] = 0.44983429f;
    data->d[6] = -0.47470734f;
    data->d[7] = -0.26405224f;
    data->d[8] = 0.44849095f;
    data->d[9] = 0.15967621f;
    data->d[10] = -0.35482895f;
    data->d[11] = -0.62260884f;
    data->d[12] = -0.15631256f;
    data->d[13] = -0.45039755f;
    data->d[14] = -0.64762431f;
    data->d[15] = -0.00204388f;
    data->d[16] = 0.93223703f;
    data->d[17] = -0.08734818f;
    data->d[18] = -0.26411283f;
    data->d[19] = -3.10107780f;
    data->d[20] = -0.44075006f;
    data->d[21] = -0.78896785f;
    data->d[22] = 0.11181091f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(22, (FireStarterOpcode)2, 8);
    ...
    code->SetOperation(26, (FireStarterOpcode)2, 18);
    code->SetOperation(27, (FireStarterOpcode)1, 17);
    code->SetOperation(28, (FireStarterOpcode)2, 20);
    code->SetOperation(29, (FireStarterOpcode)0, 10);
    code->SetOperation(30, (FireStarterOpcode)0, 21);
    code->SetOperation(31, (FireStarterOpcode)2, 22);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.81734365f;
