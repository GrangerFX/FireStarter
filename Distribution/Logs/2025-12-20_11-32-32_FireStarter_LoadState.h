...
// Run date: 12/20/25 11:32:32 Pacific Standard Time
// Run duration = 654.852606 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.84081441
...
{
    *(result->MaxResult()) = 0.84081441f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = 0.10307827f;
    data->d[1] = 0.10714209f;
    data->d[2] = -0.00116995f;
    data->d[3] = 0.09032943f;
    data->d[4] = -0.89444906f;
    data->d[5] = -1.23645520f;
    data->d[6] = 0.05438393f;
    data->d[7] = 0.36025199f;
    data->d[8] = 0.24851047f;
    data->d[9] = -0.51352692f;
    data->d[10] = -0.76815993f;
    data->d[11] = 0.92641079f;
    data->d[12] = -0.57442808f;
    data->d[13] = -0.17421432f;
    data->d[14] = 0.13987188f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(4, (FireStarterOpcode)2, 0);
    code->SetOperation(5, (FireStarterOpcode)2, 1);
    code->SetOperation(6, (FireStarterOpcode)1, 0);
    ...
    code->SetOperation(10, (FireStarterOpcode)0, 5);
    code->SetOperation(11, (FireStarterOpcode)0, 6);
    code->SetOperation(12, (FireStarterOpcode)0, 7);
    code->SetOperation(13, (FireStarterOpcode)2, 8);
    code->SetOperation(14, (FireStarterOpcode)2, 1);
    code->SetOperation(15, (FireStarterOpcode)1, 9);
    code->SetOperation(16, (FireStarterOpcode)1, 8);
    code->SetOperation(17, (FireStarterOpcode)0, 10);
    code->SetOperation(18, (FireStarterOpcode)1, 1);
    code->SetOperation(19, (FireStarterOpcode)1, 6);
    code->SetOperation(20, (FireStarterOpcode)0, 6);
    code->SetOperation(21, (FireStarterOpcode)2, 0);
    code->SetOperation(22, (FireStarterOpcode)2, 6);
    code->SetOperation(23, (FireStarterOpcode)1, 9);
    code->SetOperation(24, (FireStarterOpcode)0, 11);
    code->SetOperation(25, (FireStarterOpcode)2, 12);
    code->SetOperation(26, (FireStarterOpcode)0, 1);
    code->SetOperation(27, (FireStarterOpcode)0, 7);
    code->SetOperation(28, (FireStarterOpcode)2, 13);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.84081441f;
