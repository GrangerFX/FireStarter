...
// Run duration = 3929.011036 seconds
// Run test = 0
// Run generation = 6
// Run evolution = 0
// Run max result = 0.86016685
...
{
    *(result->MaxResult()) = 0.86016685f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -1.97430658f;
    data->d[1] = -0.38254499f;
    data->d[2] = 0.85432309f;
    data->d[3] = 1.06164324f;
    data->d[4] = -0.26805031f;
    data->d[5] = 0.08656135f;
    data->d[6] = -0.19999968f;
    data->d[7] = -2.52530575f;
    data->d[8] = 1.35441267f;
    data->d[9] = -1.47331703f;
    data->d[10] = -1.00425220f;
    data->d[11] = 0.80395490f;
    data->d[12] = -1.55616176f;
    data->d[13] = -1.92620683f;
    data->d[14] = 1.07076573f;
    data->d[15] = 2.05595827f;
    data->d[16] = -0.94909585f;
    data->d[17] = 0.75579298f;
    data->d[18] = -0.87631404f;
    data->d[19] = -1.19732904f;
    data->d[20] = 1.85923231f;
    data->d[21] = -1.38478255f;
    data->d[22] = 0.98758960f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(14, (FireStarterOpcode)0, 0);
    ...
    code->SetOperation(19, (FireStarterOpcode)2, 16);
    ...
    code->SetOperation(25, (FireStarterOpcode)0, 21);
    code->SetOperation(26, (FireStarterOpcode)0, 22);
    code->SetOperation(27, (FireStarterOpcode)1, 3);
    code->SetOperation(28, (FireStarterOpcode)2, 4);
    code->SetOperation(29, (FireStarterOpcode)0, 15);
    code->SetOperation(30, (FireStarterOpcode)0, 3);
    code->SetOperation(31, (FireStarterOpcode)2, 7);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.86016685f;
