...
// Run duration = 23783.503621 seconds
// Run generation = 438
// Run evolution = 6
...
inline void LoadVariation0(FireStarterResult* result)
{
    ...
    data->d[12] = -0.566218f;
    data->d[13] = -0.226992f;
    data->d[14] = -16605.974609f;
    data->d[15] = -12.596290f;
    data->d[16] = -1.042876f;
    data->d[17] = 0.000000f;
    data->d[18] = 0.000000f;
    data->d[19] = 0.000000f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_generation = 438;
    state.m_evolution = 6;
    state.m_index = 6;
    state.m_copy_index = 206;
    state.m_id = 206;
    state.m_test = 15;
    state.m_seed = 630291739449936708;
    state.m_optimize_pass =2;
    state.m_oldResult = 0.000001f;
    state.m_maxResult = 0.000000f;
    state.m_evolveWeight = 0.000518f;
