...
#define MONEYMAKER_TRADING          16          // Days used for stock trading
...
#define MONEYMAKER_SESSIONS         1024        // Number of trading sessions
...
#define MONEYMAKER_OPTIMIZE_SINGLE  1           // Set to 1 to optimize using a single session
