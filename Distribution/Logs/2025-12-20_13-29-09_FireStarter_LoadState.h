...
// Run date: 12/20/25 13:29:09 Pacific Standard Time
// Run duration = 654.383977 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.83182734
...
{
    *(result->MaxResult()) = 0.83182734f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = 0.12841688f;
    data->d[1] = -0.84075487f;
    data->d[2] = -0.64820170f;
    data->d[3] = -0.49280417f;
    data->d[4] = 0.34349650f;
    data->d[5] = -0.29580396f;
    data->d[6] = 0.63379431f;
    data->d[7] = 0.44444108f;
    data->d[8] = -0.54727006f;
    data->d[9] = 0.20488721f;
    data->d[10] = -0.89142686f;
    data->d[11] = -0.62065202f;
    data->d[12] = -0.13390166f;
    data->d[13] = 0.00247445f;
    data->d[14] = 0.14427014f;
    data->d[15] = -0.64786202f;
    data->d[16] = -0.05767725f;
    data->d[17] = -0.34468040f;
    data->d[18] = -0.45743492f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(18, (FireStarterOpcode)2, 2);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.83182734f;
