...
// Run date: 03/16/25 12:23:22 Pacific Daylight Time
// Run duration = 1.997948 seconds
// Run generation = 3
// Run evolution = 0
// Run max result = 0.68196505
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
{
    *(result->MaxResult()) = 0.68196505f;
    *(result->EvolveAge1()) = 8;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.64545321f;
    data->d[1] = 1.45465517f;
    data->d[2] = -2.48958254f;
    data->d[3] = 0.76970047f;
    data->d[4] = 0.27158368f;
    data->d[5] = -1.13735759f;
    data->d[6] = 1.61928868f;
    data->d[7] = -1.25429142f;
    data->d[8] = 1.25589967f;
    data->d[9] = -1.13314819f;
    data->d[10] = 0.47723019f;
    data->d[11] = 1.56938958f;
    data->d[12] = -0.39599779f;
    data->d[13] = 2.38076258f;
    data->d[14] = -1.56171227f;
    data->d[15] = -0.81155509f;
    data->d[16] = -1.77154374f;
    data->d[17] = -1.03192341f;
    data->d[18] = -0.63849974f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(11, (FireStarterOpcode)0, 2);
    ...
    code->SetOperation(24, (FireStarterOpcode)1, 6);
