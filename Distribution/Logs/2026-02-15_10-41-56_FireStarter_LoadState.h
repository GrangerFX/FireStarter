...
// Run date: 02/15/26 10:41:56 Pacific Standard Time
// Run duration = 1109.858005 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.99948752
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(8, (FireStarterOpcode)2, 6);
    ...
    code->SetOperation(12, (FireStarterOpcode)3, 10);
    code->SetOperation(13, (FireStarterOpcode)2, 11);
    code->SetOperation(14, (FireStarterOpcode)3, 8);
    ...
    code->SetOperation(19, (FireStarterOpcode)3, 13);
    code->SetOperation(20, (FireStarterOpcode)1, 14);
    code->SetOperation(21, (FireStarterOpcode)3, 15);
    ...
    code->SetOperation(26, (FireStarterOpcode)3, 5);
    code->SetOperation(27, (FireStarterOpcode)1, 17);
    code->SetOperation(28, (FireStarterOpcode)2, 18);
    code->SetOperation(29, (FireStarterOpcode)2, 4);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.99948752f;
