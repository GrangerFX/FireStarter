...
#define FIRESTARTER_REGISTERS       16          // Data maximum registers
...
#define FIRESTARTER_SM_COUNT_1070   17          // GTX 1070
...
#define FIRESTARTER_MONEYMAKER_POPULATION       2 * FIRESTARTER_SM_COUNT_5090 * FIRESTARTER_WARP_THREADS
