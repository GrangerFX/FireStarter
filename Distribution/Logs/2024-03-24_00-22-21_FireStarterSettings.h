...
#define FIRESTARTER_EVOLVE_TEST     1           // Temporary test evolution modes.
...
#if FIRESTARTER_EVOLVE_TEST == 1            // 16 tests of 16 states for 200 generations.
...
#elif FIRESTARTER_EVOLVE_TEST == 2          // 16 tests of 1 states for unlimited generations.
#define FIRESTARTER_EVOLVE_TESTS            16
...
#define FIRESTARTER_EVOLVE_START_RESULT     10.0f
#define FIRESTARTER_EVOLVE_OPTIMIZE         8
#elif FIRESTARTER_EVOLVE_TEST == 3          // 16 tests of 16 states for unlimited generations.
#define FIRESTARTER_EVOLVE_TESTS            16
