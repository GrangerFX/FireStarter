...
// Run date: 01/24/26 08:58:22 Pacific Standard Time
// Run duration = 2452.829023 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.99890703
...
inline void LoadSettings(FireStarterSettings& settings)
{
    ...
    settings.m_history = 392;
    settings.m_variation = 360;
    settings.m_tradingMin = 16;
    settings.m_tradingMax = 16;
...
{
    *(result->MaxResult()) = 0.99890703f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.23510420f;
    data->d[1] = -0.88223088f;
    data->d[2] = 0.71440512f;
    data->d[3] = -0.53011250f;
    data->d[4] = -0.27870002f;
    data->d[5] = 0.49414292f;
    data->d[6] = -0.26421511f;
    data->d[7] = 0.37046877f;
    data->d[8] = -0.59098506f;
    data->d[9] = 0.52291411f;
    data->d[10] = 0.66491878f;
    data->d[11] = 0.36796290f;
    data->d[12] = 0.64657253f;
    data->d[13] = -0.48410267f;
    data->d[14] = -0.02468807f;
    data->d[15] = 0.26670143f;
    data->d[16] = 0.05910374f;
    data->d[17] = -0.94832468f;
    data->d[18] = 0.10155775f;
    data->d[19] = 0.03421085f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(11, (FireStarterOpcode)2, 10);
    ...
    code->SetOperation(19, (FireStarterOpcode)2, 1);
    ...
    code->SetOperation(23, (FireStarterOpcode)2, 17);
    code->SetOperation(24, (FireStarterOpcode)1, 8);
    ...
    code->SetOperation(29, (FireStarterOpcode)2, 19);
    code->SetOperation(30, (FireStarterOpcode)2, 9);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.99890703f;
