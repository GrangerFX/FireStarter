...
// Run date: 01/24/24 18:38:26 Pacific Standard Time
// Run duration = 28292.064326 seconds
// Run generation = 85
// Run evolution = 11
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_children0 = 85;
    state.m_children1 = 1;
    state.m_index = 0;
    state.m_copy_index = 11;
    state.m_id = 0;
    state.m_test = 252;
    state.m_seed = 16129038309174770414;
    state.m_optimize_pass =8;
    state.m_oldResult = 0.000115f;
    state.m_maxResult = 0.000035f;
    state.m_evolveWeight = 0.000308f;
