...
// Run date: 05/25/25 16:54:28 Pacific Daylight Time
// Run duration = 767.507846 seconds
// Run test = 255
// Run generation = 2
// Run evolution = 0
// Run precision  = 0.00000000
// Run max result = 0.00000088
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
{
    *(result->MaxResult()) = 0.00000088f;
    *(result->EvolveAge1()) = 2;
    *(result->EvolveAge2()) = 1;
    FireStarterData *data = result->Data();
    data->d[0] = -3.14159274f;
    data->d[1] = -0.47455996f;
    data->d[2] = 0.36853892f;
    data->d[3] = -0.61981779f;
    data->d[4] = 2.91878366f;
    data->d[5] = 0.04668431f;
    data->d[6] = -0.50702733f;
    data->d[7] = 0.53551817f;
    data->d[8] = -0.03757134f;
    data->d[9] = -40.01650238f;
    data->d[10] = 1.72823358f;
    data->d[11] = -0.50346953f;
    data->d[12] = -0.97444099f;
    data->d[13] = 1.61137295f;
    data->d[14] = -2.34420419f;
    data->d[15] = 1.55156398f;
    data->d[16] = 1.05288613f;
    data->d[17] = -0.92269140f;
    data->d[18] = -1.17849886f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.00000088f;
