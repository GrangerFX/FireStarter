...
// Run date: 12/14/25 13:19:09 Pacific Standard Time
// Run duration = 62.184560 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.85231292
...
{
    *(result->MaxResult()) = 0.85231292f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = 0.21013981f;
    data->d[1] = -0.89701074f;
    data->d[2] = 0.29547021f;
    data->d[3] = 0.39137101f;
    data->d[4] = 0.93091375f;
    data->d[5] = -0.30889893f;
    data->d[6] = 0.14498809f;
    data->d[7] = -0.75261587f;
    data->d[8] = -0.65141582f;
    data->d[9] = -0.98802030f;
    data->d[10] = -0.67795342f;
    data->d[11] = -0.86779344f;
    data->d[12] = -0.43640807f;
    data->d[13] = 0.00987917f;
    data->d[14] = 0.45828345f;
    data->d[15] = -0.70676714f;
    data->d[16] = 0.15153086f;
    data->d[17] = -0.47744817f;
    data->d[18] = -0.28822604f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.85231292f;
