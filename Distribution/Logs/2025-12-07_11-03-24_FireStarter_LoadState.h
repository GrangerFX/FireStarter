...
// Run date: 12/07/25 11:03:24 Pacific Standard Time
// Run duration = 6343.192404 seconds
// Run test = 0
// Run generation = 7
// Run evolution = 0
// Run max result = 0.82143408
...
{
    *(result->MaxResult()) = 0.82143408f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.08524147f;
    data->d[1] = 0.89369458f;
    data->d[2] = -0.25964287f;
    data->d[3] = 0.94269919f;
    data->d[4] = -0.94085413f;
    data->d[5] = -0.78296387f;
    data->d[6] = -0.24664836f;
    data->d[7] = 0.72181898f;
    data->d[8] = -1.64947104f;
    data->d[9] = 0.85667562f;
    data->d[10] = 0.55964595f;
    data->d[11] = 0.88889807f;
    data->d[12] = 0.24193798f;
    data->d[13] = -0.70691150f;
    data->d[14] = -0.08523134f;
    data->d[15] = 0.77128059f;
    data->d[16] = 0.06885053f;
    data->d[17] = -0.44438195f;
    data->d[18] = -0.35194346f;
    data->d[19] = 0.48456135f;
    data->d[20] = -0.91215271f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(30, (FireStarterOpcode)2, 13);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.82143408f;
