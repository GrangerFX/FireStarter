...
// Run date: 12/01/24 12:51:15 Pacific Standard Time
// Run duration = 650.054743 seconds
// Run generation = 9
// Run evolution = 0
...
inline void LoadVariation0(FireStarterResult* result)
{
    ...
    data->d[0] = 0.37835112f;
    data->d[1] = -1.18862510f;
    data->d[2] = 0.06539704f;
    data->d[3] = 2.53599429f;
    data->d[4] = -0.32132176f;
    data->d[5] = -2.22227788f;
    data->d[6] = 1.77003491f;
    data->d[7] = 0.09913540f;
    data->d[8] = -0.65087658f;
    data->d[9] = -0.72982442f;
    data->d[10] = -2.17393947f;
    data->d[11] = -1.98183501f;
    data->d[12] = 1.78404403f;
    data->d[13] = -1.88722301f;
    data->d[14] = 2.48339152f;
    data->d[15] = 0.91666758f;
    data->d[16] = -0.59029430f;
    data->d[17] = 4.81360054f;
    data->d[18] = 1.60627270f;
    data->d[19] = -1.05208898f;
    data->d[20] = 0.38232362f;
    data->d[21] = -1.86977100f;
    data->d[22] = 1.17144608f;
    data->d[23] = -2.49430943f;
    data->d[24] = 0.36812699f;
    data->d[25] = -1.58695912f;
    data->d[26] = -1.92722309f;
    data->d[27] = -1.71094418f;
    data->d[28] = 1.66394687f;
    data->d[29] = 0.22020580f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 0;
    state.m_test = 255;
    state.m_seed = 4172340983833127324;
