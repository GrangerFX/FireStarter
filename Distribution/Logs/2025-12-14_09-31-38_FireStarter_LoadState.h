...
// Run date: 12/14/25 09:31:38 Pacific Standard Time
// Run duration = 21.538494 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.88389307
...
{
    *(result->MaxResult()) = 0.88389307f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = 0.03718829f;
    data->d[1] = 0.68720311f;
    data->d[2] = 0.22913265f;
    data->d[3] = -0.31557047f;
    data->d[4] = -0.02441580f;
    data->d[5] = 0.62890810f;
    data->d[6] = 0.86317581f;
    data->d[7] = 0.05958298f;
    data->d[8] = -0.06689209f;
    data->d[9] = 0.45403439f;
    data->d[10] = 0.65373200f;
    data->d[11] = -0.91922015f;
    data->d[12] = -0.64446241f;
    data->d[13] = 2.01470470f;
    data->d[14] = 0.56485194f;
    data->d[15] = 0.23371010f;
    data->d[16] = -0.88532400f;
    data->d[17] = 0.24342188f;
    data->d[18] = -1.15829349f;
    data->d[19] = -0.90215439f;
    data->d[20] = 0.24541418f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(11, (FireStarterOpcode)2, 11);
    ...
    code->SetOperation(25, (FireStarterOpcode)2, 2);
    code->SetOperation(26, (FireStarterOpcode)1, 11);
    ...
    code->SetOperation(30, (FireStarterOpcode)2, 15);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.88389307f;
