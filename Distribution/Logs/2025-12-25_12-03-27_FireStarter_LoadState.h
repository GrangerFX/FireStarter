...
// Run date: 12/25/25 12:03:27 Pacific Standard Time
// Run duration = 433.901970 seconds
// Run test = 71
// Run generation = 1
// Run evolution = 0
// Run precision  = 0.00000369
// Run max result = 0.00003184
...
{
    *(result->MaxResult()) = 0.00003184f;
    *(result->EvolveAge1()) = 2;
    *(result->EvolveAge2()) = 11;
    FireStarterData *data = result->Data();
    data->d[0] = -0.76356155f;
    data->d[1] = -2.32862258f;
    data->d[2] = -0.12026402f;
    data->d[3] = -0.19229898f;
    data->d[4] = -0.24694893f;
    data->d[5] = 0.81768137f;
    data->d[6] = -1.66553426f;
    data->d[7] = 1.73824131f;
    data->d[8] = 0.11761145f;
    data->d[9] = -0.95370305f;
    data->d[10] = 0.90581852f;
    data->d[11] = 0.25109896f;
    data->d[12] = -2.44781780f;
    data->d[13] = 1.55911124f;
    data->d[14] = -3.60045314f;
    data->d[15] = -0.21495344f;
    data->d[16] = 0.87432200f;
    data->d[17] = -1.95386314f;
    data->d[18] = -2.21583033f;
    data->d[19] = 0.00002782f;
    data->d[20] = -0.49043390f;
    data->d[21] = 1.26303601f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(21, (FireStarterOpcode)0, 6);
    ...
    code->SetOperation(29, (FireStarterOpcode)0, 21);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 0;
    state.m_test = 71;
    state.m_seed = 14873205705374428610;
    state.m_optimize_pass = 0;
    state.m_bestResult = 0.00003184f;
