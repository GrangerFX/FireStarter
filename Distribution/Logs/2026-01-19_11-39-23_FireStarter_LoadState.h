...
// Run date: 01/19/26 11:39:23 Pacific Standard Time
// Run duration = 811.526876 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 1.09880650
...
{
    *(result->MaxResult()) = 1.09880650f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = 1.87097645f;
    data->d[1] = 0.69176465f;
    data->d[2] = -0.91476083f;
    data->d[3] = -0.24372081f;
    data->d[4] = 0.28241733f;
    data->d[5] = -0.14843681f;
    data->d[6] = -1.01833379f;
    data->d[7] = 1.19830930f;
    data->d[8] = -0.56093228f;
    data->d[9] = 0.73319840f;
    data->d[10] = -0.49005449f;
    data->d[11] = 1.08213258f;
    data->d[12] = 0.11972899f;
    data->d[13] = -0.44707611f;
    data->d[14] = -0.56078106f;
    data->d[15] = -0.62862867f;
    data->d[16] = 1.77588522f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(16, (FireStarterOpcode)2, 7);
    code->SetOperation(17, (FireStarterOpcode)1, 12);
    code->SetOperation(18, (FireStarterOpcode)1, 0);
    ...
    code->SetOperation(28, (FireStarterOpcode)2, 1);
    code->SetOperation(29, (FireStarterOpcode)2, 12);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 1.09880650f;
