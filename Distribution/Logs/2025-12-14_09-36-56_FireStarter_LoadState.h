...
// Run date: 12/14/25 09:36:56 Pacific Standard Time
// Run duration = 3.584238 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.79999685
...
{
    *(result->MaxResult()) = 0.79999685f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.70561177f;
    data->d[1] = -0.70370883f;
    data->d[2] = -0.06324335f;
    data->d[3] = 0.98332888f;
    data->d[4] = -0.24547194f;
    data->d[5] = 0.12142781f;
    data->d[6] = -0.83547932f;
    data->d[7] = 0.48012710f;
    data->d[8] = -0.08567057f;
    data->d[9] = 0.60803568f;
    data->d[10] = 0.33712012f;
    data->d[11] = -0.63302034f;
    data->d[12] = 0.78873044f;
    data->d[13] = -0.11555466f;
    data->d[14] = 0.43867627f;
    data->d[15] = -0.61907768f;
    data->d[16] = -0.15372886f;
    data->d[17] = 0.72535533f;
    data->d[18] = -0.86613601f;
    data->d[19] = -0.36582246f;
    data->d[20] = 0.15412879f;
    data->d[21] = 0.37811625f;
    data->d[22] = 0.57431036f;
    data->d[23] = 0.14278187f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(19, (FireStarterOpcode)2, 13);
    code->SetOperation(20, (FireStarterOpcode)2, 17);
    code->SetOperation(21, (FireStarterOpcode)2, 3);
    code->SetOperation(22, (FireStarterOpcode)1, 18);
    code->SetOperation(23, (FireStarterOpcode)2, 19);
    code->SetOperation(24, (FireStarterOpcode)2, 20);
    ...
    code->SetOperation(28, (FireStarterOpcode)2, 22);
    code->SetOperation(29, (FireStarterOpcode)0, 23);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.79999685f;
