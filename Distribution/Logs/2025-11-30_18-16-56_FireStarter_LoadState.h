...
// Run date: 11/30/25 18:16:56 Pacific Standard Time
// Run duration = 7063.363735 seconds
// Run test = 0
// Run generation = 8
// Run evolution = 0
// Run max result = 0.83007604
...
{
    *(result->MaxResult()) = 0.83007604f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = 1.38179612f;
    data->d[1] = -2.33077812f;
    data->d[2] = -2.00633264f;
    data->d[3] = -0.74503928f;
    data->d[4] = 1.85822654f;
    data->d[5] = 0.58094621f;
    data->d[6] = 1.51721168f;
    data->d[7] = 1.42542291f;
    data->d[8] = 1.63078833f;
    data->d[9] = -1.39156032f;
    data->d[10] = -0.71894360f;
    data->d[11] = -0.29052794f;
    data->d[12] = 2.37471080f;
    data->d[13] = 0.82687128f;
    data->d[14] = 0.07111865f;
    data->d[15] = -0.14061986f;
    data->d[16] = 1.13775384f;
    data->d[17] = -1.83498335f;
    data->d[18] = -0.50671482f;
    data->d[19] = -3.18007994f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(12, (FireStarterOpcode)2, 11);
    ...
    code->SetOperation(16, (FireStarterOpcode)2, 4);
    ...
    code->SetOperation(21, (FireStarterOpcode)2, 17);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.83007604f;
