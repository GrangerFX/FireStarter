...
#define MONEYMAKER_EVOLVE_ONE       0           // Set to 1 to evolve each stock individually
#define MONEYMAKER_OPTIMIZE_ONE     1           // Set to 1 to optimize each stock individually
