...
// Run duration = 9147.935700 seconds
// Run generation = 12
// Run evolution = 8
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_evolution = 8;
    state.m_children0 = 216;
    state.m_children1 = 216;
    state.m_index = 35;
    state.m_copy_index = 52;
    state.m_id = 52;
    state.m_test = 3;
    state.m_seed = 12946506408652458259;
    state.m_optimize_pass =3;
    state.m_oldResult = 0.000003f;
    state.m_maxResult = 0.000002f;
    state.m_evolveWeight = 0.000009f;
