...
// Run date: 12/24/25 18:00:53 Pacific Standard Time
// Run duration = 31.518483 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
...
{
    *(result->MaxResult()) = 0.89403409f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.02853114f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.89403409f;
