...
// Run date: 10/12/25 09:08:09 Pacific Daylight Time
// Run duration = 1376.806648 seconds
// Run test = 0
// Run generation = 94
// Run evolution = 0
// Run precision  = 10.00000000
// Run max result = 0.41030115
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
{
    *(result->MaxResult()) = 0.41030115f;
    *(result->EvolveAge1()) = 2;
    *(result->EvolveAge2()) = 112;
    FireStarterData *data = result->Data();
    data->d[0] = 2.35525441f;
    data->d[1] = 2.23204112f;
    data->d[2] = -1.23155880f;
    data->d[3] = -0.60884923f;
    data->d[4] = -1.60170376f;
    data->d[5] = -2.49458504f;
    data->d[6] = 2.17711186f;
    data->d[7] = 1.24828684f;
    data->d[8] = 1.63683605f;
    data->d[9] = -2.01433110f;
    data->d[10] = 0.23999202f;
    data->d[11] = 1.41034305f;
    data->d[12] = -0.28873420f;
    data->d[13] = -1.67708266f;
    data->d[14] = -1.10025656f;
    data->d[15] = -0.06789158f;
    data->d[16] = -1.01285005f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 0;
    state.m_test = 0;
    state.m_seed = 3816120392938452218;
    state.m_optimize_pass = 0;
    state.m_bestResult = 0.41030115f;
