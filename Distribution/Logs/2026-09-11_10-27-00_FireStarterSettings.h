...
#define FIRESTARTER_MONEYOPTIMIZE_STREAMS       1
...
#define FIRESTARTER_MONEYOPTIMIZE_PASSES        384 // 384 // FIRESTARTER_PASSES
...
public:
    ...
    inline FireStarterSetting(unsigned int mode = FIRESTARTER_AUTO) 
    {
        ...
        switch (m_mode) {
            ...
            case FIRESTARTER_MONEYOPTIMIZE:
                m_streams =     FIRESTARTER_MONEYOPTIMIZE_STREAMS;
