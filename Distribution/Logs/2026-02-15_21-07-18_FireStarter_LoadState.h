...
// Run date: 02/15/26 21:07:18 Pacific Standard Time
// Run duration = 1077.373472 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.99876702
...
{
    *(result->MaxResult()) = 0.99876702f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.99864680f;
    data->d[1] = -0.67622983f;
    data->d[2] = -0.20506868f;
    data->d[3] = -0.31365439f;
    data->d[4] = 0.05297288f;
    data->d[5] = -0.45629358f;
    data->d[6] = -0.03811605f;
    data->d[7] = 0.38692054f;
    data->d[8] = -0.38586184f;
    data->d[9] = -0.41464046f;
    data->d[10] = -0.07024930f;
    data->d[11] = 0.87328559f;
    data->d[12] = 0.30165198f;
    data->d[13] = -0.51411229f;
    data->d[14] = -0.20382631f;
    data->d[15] = -0.29881141f;
    data->d[16] = -0.53828603f;
    data->d[17] = -0.31737545f;
    data->d[18] = -0.16923511f;
    data->d[19] = 0.65136528f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(3, (FireStarterOpcode)1, 0);
    ...
    code->SetOperation(18, (FireStarterOpcode)2, 11);
    ...
    code->SetOperation(26, (FireStarterOpcode)0, 11);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.99876702f;
