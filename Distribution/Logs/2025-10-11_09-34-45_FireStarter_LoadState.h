...
// Run date: 10/11/25 09:34:45 Pacific Daylight Time
// Run duration = 50.083545 seconds
// Run test = 0
// Run generation = 2
// Run evolution = 0
// Run precision  = 10.00000000
// Run max result = 0.44478473
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
{
    *(result->MaxResult()) = 0.44478473f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 93;
    FireStarterData *data = result->Data();
    data->d[0] = -0.36893374f;
    data->d[1] = -0.68125671f;
    data->d[2] = 0.23628274f;
    data->d[3] = -1.09594834f;
    data->d[4] = -0.95830375f;
    data->d[5] = -0.30359873f;
    data->d[6] = -2.36551094f;
    data->d[7] = -0.59158957f;
    data->d[8] = 2.37865758f;
    data->d[9] = -0.14565767f;
    data->d[10] = -0.74373281f;
    data->d[11] = 0.87229669f;
    data->d[12] = -2.38959956f;
    data->d[13] = -1.03201020f;
    data->d[14] = 1.58027768f;
    data->d[15] = -0.43572664f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.44478473f;
