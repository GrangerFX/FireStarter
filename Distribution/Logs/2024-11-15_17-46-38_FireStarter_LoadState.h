...
// Run duration = 790.489994 seconds
// Run generation = 2
// Run evolution = 0
...
inline void LoadVariation0(FireStarterResult* result)
{
    ...
    data->d[1] = 0.19454555f;
    data->d[2] = -0.18739268f;
    data->d[3] = 0.84200537f;
    data->d[4] = 7.23100281f;
    data->d[5] = 0.11297710f;
    data->d[6] = -4.60673857f;
    data->d[7] = -2.98872805f;
    data->d[8] = -0.45209581f;
    data->d[9] = 2.02443027f;
    data->d[10] = -0.33512813f;
    data->d[11] = 0.46383116f;
    data->d[12] = -3.32436180f;
    data->d[13] = 1.78865862f;
    data->d[14] = -3.83650923f;
    data->d[15] = -0.34733400f;
    data->d[16] = -5.69520044f;
    data->d[17] = -5.71726465f;
    data->d[18] = -16.11630249f;
    data->d[19] = -1.07723582f;
    data->d[20] = -3.16452646f;
    data->d[21] = 1.56744099f;
    data->d[22] = -1.68606138f;
    data->d[23] = -1.82055938f;
    data->d[24] = -1.05354190f;
    data->d[25] = -0.82318377f;
    data->d[26] = -0.87464380f;
    data->d[27] = -2.46762347f;
    data->d[28] = 1.55916107f;
    data->d[29] = -2.41953897f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 0;
    state.m_test = 255;
    state.m_seed = 11317875074106452244;
