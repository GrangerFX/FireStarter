...
// Run date: 11/23/25 21:11:52 Pacific Standard Time
// Run duration = 2736.459982 seconds
// Run test = 0
// Run generation = 3
// Run evolution = 0
// Run max result = 0.84591490
...
{
    *(result->MaxResult()) = 0.84591490f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.76310688f;
    data->d[1] = 0.75242609f;
    data->d[2] = -2.36327171f;
    data->d[3] = -1.13685298f;
    data->d[4] = -1.37129915f;
    data->d[5] = -1.86470842f;
    data->d[6] = -1.38346958f;
    data->d[7] = -0.10244268f;
    data->d[8] = 0.41154653f;
    data->d[9] = -0.36431298f;
    data->d[10] = 1.89234269f;
    data->d[11] = -2.18588448f;
    data->d[12] = 0.38131681f;
    data->d[13] = 1.08966815f;
    data->d[14] = -2.16820097f;
    data->d[15] = 2.28465939f;
    data->d[16] = 0.93945271f;
    data->d[17] = 0.06039694f;
    data->d[18] = -0.16265856f;
    data->d[19] = -1.16129410f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(21, (FireStarterOpcode)2, 7);
    code->SetOperation(22, (FireStarterOpcode)1, 4);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.84591490f;
