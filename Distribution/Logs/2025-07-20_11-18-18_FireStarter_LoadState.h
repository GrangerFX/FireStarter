...
// Run date: 07/20/25 11:18:18 Pacific Daylight Time
// Run duration = 56.144968 seconds
// Run test = 0
// Run generation = 26
// Run evolution = 0
// Run precision  = 1.40831470
// Run max result = 0.05302429
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
inline void LoadVariation0(FireStarterResult* result)
{
    ...
    *(result->EvolveAge2()) = 0;
    ...
    data->d[3] = 0.42758623f;
    data->d[4] = -0.00000000f;
    data->d[5] = -0.00000000f;
    data->d[6] = 0.04337883f;
    data->d[7] = 0.00000000f;
    data->d[8] = 0.04207915f;
    data->d[9] = -2.16584158f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.05302429f;
    state.m_oldResult = 0.09305048f;
