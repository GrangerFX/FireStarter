...
// Run date: 01/04/26 15:13:51 Pacific Standard Time
// Run duration = 1097.887837 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.15490191
...
{
    *(result->MaxResult()) = 0.15490191f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.59168905f;
    data->d[1] = -0.54056323f;
    data->d[2] = -1.92727375f;
    data->d[3] = 0.14349934f;
    data->d[4] = -0.04630919f;
    data->d[5] = -0.30780798f;
    data->d[6] = 0.74529809f;
    data->d[7] = -0.98797590f;
    data->d[8] = 0.30170202f;
    data->d[9] = -0.09750365f;
    data->d[10] = -0.11221068f;
    data->d[11] = 0.78721404f;
    data->d[12] = -0.00784959f;
    data->d[13] = -0.72086734f;
    data->d[14] = -0.37468836f;
    data->d[15] = -0.53107804f;
    data->d[16] = -0.83360875f;
    data->d[17] = -0.26702464f;
    data->d[18] = -0.41323832f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(13, (FireStarterOpcode)1, 6);
    code->SetOperation(14, (FireStarterOpcode)2, 9);
    ...
    code->SetOperation(19, (FireStarterOpcode)0, 9);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.15490191f;
