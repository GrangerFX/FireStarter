...
// Run duration = 201.362214 seconds
// Run test = 23
// Run generation = 25
// Run evolution = 0
// Run precision  = 0.00000916
// Run max result = 0.00000108
...
{
    *(result->MaxResult()) = 0.00000108f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 11;
    FireStarterData *data = result->Data();
    data->d[0] = -3.14159274f;
    data->d[1] = 0.17882095f;
    data->d[2] = -1.45301616f;
    data->d[3] = -0.24790893f;
    data->d[4] = 1.41547775f;
    data->d[5] = -0.63105935f;
    data->d[6] = 1.98702693f;
    data->d[7] = 0.30424044f;
    data->d[8] = -1.98445582f;
    data->d[9] = 0.71195382f;
    data->d[10] = 2.36774588f;
    data->d[11] = -0.47161081f;
    data->d[12] = -2.67202115f;
    data->d[13] = 1.38577521f;
    data->d[14] = -1.57724583f;
    data->d[15] = -6.66439104f;
    data->d[16] = -0.00106190f;
    data->d[17] = -0.07887591f;
    data->d[18] = 5.19686365f;
    data->d[19] = 1.36311758f;
    data->d[20] = -0.86143684f;
    data->d[21] = -0.09651816f;
    data->d[22] = -2.07054281f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 0;
    state.m_test = 23;
    state.m_seed = 14161520419224319706;
    state.m_optimize_pass = 0;
    state.m_bestResult = 0.00000108f;
