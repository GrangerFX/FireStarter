...
// Run date: 09/20/25 16:13:05 Pacific Daylight Time
// Run duration = 17.116298 seconds
// Run test = 0
// Run generation = 2
// Run evolution = 0
// Run precision  = 1.67010784
// Run max result = 0.57324386
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
{
    *(result->MaxResult()) = 0.57324386f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 25;
    FireStarterData *data = result->Data();
    data->d[0] = 0.95407075f;
    data->d[1] = -2.16074371f;
    data->d[2] = -1.98510408f;
    data->d[3] = 1.03458846f;
    data->d[4] = -1.73805237f;
    data->d[5] = 0.32123095f;
    data->d[6] = 0.11178680f;
    data->d[7] = 1.89001739f;
    data->d[8] = -1.16097486f;
    data->d[9] = 0.71036148f;
    data->d[10] = 1.49831593f;
    data->d[11] = -1.53745914f;
    data->d[12] = 0.80677748f;
    data->d[13] = -1.38989687f;
    data->d[14] = 0.53724700f;
    data->d[15] = 1.21412861f;
    data->d[16] = 0.08411319f;
    data->d[17] = -0.92991084f;
    data->d[18] = 2.02068090f;
    data->d[19] = 2.02037239f;
    data->d[20] = 0.20364732f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(23, (FireStarterOpcode)2, 13);
    ...
    code->SetOperation(28, (FireStarterOpcode)2, 14);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.57324386f;
