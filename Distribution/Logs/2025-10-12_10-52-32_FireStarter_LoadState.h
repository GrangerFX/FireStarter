...
// Run date: 10/12/25 10:52:32 Pacific Daylight Time
// Run duration = 688.790794 seconds
// Run test = 0
// Run generation = 33
// Run evolution = 0
// Run precision  = 10.00000000
// Run max result = 0.43719444
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
{
    *(result->MaxResult()) = 0.43719444f;
    *(result->EvolveAge1()) = 2;
    *(result->EvolveAge2()) = 168;
    FireStarterData *data = result->Data();
    data->d[0] = 1.25517654f;
    data->d[1] = 1.65391397f;
    data->d[2] = -1.94997919f;
    data->d[3] = -2.43862486f;
    data->d[4] = 1.52982807f;
    data->d[5] = 1.16723466f;
    data->d[6] = -0.25262052f;
    data->d[7] = 1.37728131f;
    data->d[8] = 0.25110012f;
    data->d[9] = -1.38424993f;
    data->d[10] = 0.76480377f;
    data->d[11] = -1.19836116f;
    data->d[12] = -1.31742465f;
    data->d[13] = -0.05764207f;
    data->d[14] = -0.96230471f;
    data->d[15] = -1.17653394f;
    data->d[16] = 1.23445046f;
    data->d[17] = -0.05985439f;
    data->d[18] = -1.22680771f;
    data->d[19] = 1.38490653f;
    data->d[20] = 0.35057649f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(19, (FireStarterOpcode)1, 10);
    code->SetOperation(20, (FireStarterOpcode)0, 15);
    code->SetOperation(21, (FireStarterOpcode)1, 16);
    code->SetOperation(22, (FireStarterOpcode)2, 17);
    code->SetOperation(23, (FireStarterOpcode)1, 0);
    ...
    code->SetOperation(31, (FireStarterOpcode)2, 20);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 0;
    state.m_test = 0;
    state.m_seed = 16254090665626540915;
    state.m_optimize_pass = 0;
    state.m_bestResult = 0.43719444f;
