...
// Run date: 12/28/25 13:41:26 Pacific Standard Time
// Run duration = 1104.499574 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.73798311
...
{
    *(result->MaxResult()) = 0.73798311f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = 0.65044528f;
    data->d[1] = -0.33574811f;
    data->d[2] = -0.75579435f;
    data->d[3] = -0.55403847f;
    data->d[4] = 0.00154966f;
    data->d[5] = -0.37183961f;
    data->d[6] = 0.01502539f;
    data->d[7] = 0.36765260f;
    data->d[8] = -0.92188460f;
    data->d[9] = 0.98866540f;
    data->d[10] = -0.76346189f;
    data->d[11] = 2.44491029f;
    data->d[12] = -0.84163195f;
    data->d[13] = -0.02400562f;
    data->d[14] = 0.64739424f;
    data->d[15] = 0.00692715f;
    data->d[16] = -0.69777775f;
    data->d[17] = 0.87081027f;
    data->d[18] = 0.82595390f;
    data->d[19] = 0.52401370f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(12, (FireStarterOpcode)2, 6);
    ...
    code->SetOperation(29, (FireStarterOpcode)2, 6);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.73798311f;
