...
#define MONEYMAKER_WARMUP           16          // Days of stock used for warmup prior to training
#define MONEYMAKER_VALIDATION       64          // Days of stock used to validate the data
#define MONEYMAKER_TRAINING         (MONEYMAKER_HISTORY - MONEYMAKER_VALIDATION) // Days used for training
...
public:
    ...
    unsigned int m_training =       MONEYMAKER_TRAINING;
