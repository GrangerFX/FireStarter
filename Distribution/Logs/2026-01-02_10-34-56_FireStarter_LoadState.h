...
// Run date: 01/02/26 10:34:56 Pacific Standard Time
// Run duration = 1069.397295 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.77222371
...
{
    *(result->MaxResult()) = 0.77222371f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = 0.99272233f;
    data->d[1] = 0.94847637f;
    data->d[2] = -0.51136661f;
    data->d[3] = -0.96479493f;
    data->d[4] = 0.09042269f;
    data->d[5] = 0.29361004f;
    data->d[6] = -0.17126876f;
    data->d[7] = 0.42283899f;
    data->d[8] = 0.16618107f;
    data->d[9] = 0.74355859f;
    data->d[10] = 0.52843446f;
    data->d[11] = 0.35626572f;
    data->d[12] = 0.85171086f;
    data->d[13] = -0.46393329f;
    data->d[14] = 0.29293036f;
    data->d[15] = -0.71532232f;
    data->d[16] = 0.54910338f;
    data->d[17] = 0.12014987f;
    data->d[18] = 0.54560959f;
    data->d[19] = 0.46959230f;
    data->d[20] = -0.49292621f;
    data->d[21] = -0.12610722f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(9, (FireStarterOpcode)2, 1);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.77222371f;
