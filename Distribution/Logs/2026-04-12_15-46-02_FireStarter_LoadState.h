...
// Run date: 04/12/26 15:46:02 Pacific Daylight Time
// Run duration = 38.534794 seconds
// Run test = 7
// Run generation = 8
// Run evolution = 0
// Run precision  = 0.00000585
// Run max result = 0.00000150
...
{
    *(result->MaxResult()) = 0.00000150f;
    *(result->EvolveAge1()) = 2;
    *(result->EvolveAge2()) = 4;
    FireStarterData *data = result->Data();
    data->d[0] = -3.02755404f;
    data->d[1] = 0.98949707f;
    data->d[2] = -2.35110402f;
    data->d[3] = 1.63968682f;
    data->d[4] = -1.91144419f;
    data->d[5] = 0.33025977f;
    data->d[6] = 0.66981238f;
    data->d[7] = 0.10271314f;
    data->d[8] = -15.80761433f;
    data->d[9] = -0.10927754f;
    data->d[10] = -0.75255281f;
    data->d[11] = -8.92193222f;
    data->d[12] = 0.77015221f;
    data->d[13] = 4.73228121f;
    data->d[14] = 0.00784883f;
    data->d[15] = -0.14338681f;
    data->d[16] = 0.16926372f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 0;
    state.m_test = 7;
    state.m_seed = 10554462855316383495;
    state.m_optimize_pass = 0;
    state.m_bestResult = 0.00000150f;
