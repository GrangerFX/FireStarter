...
// Run date: 12/13/25 10:25:31 Pacific Standard Time
// Run duration = 652.603850 seconds
// Run test = 0
// Run generation = 13
// Run evolution = 0
// Run max result = 0.86073077
...
{
    *(result->MaxResult()) = 0.86073077f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = 0.68398720f;
    data->d[1] = 0.02969768f;
    data->d[2] = 0.54388011f;
    data->d[3] = -0.76452816f;
    data->d[4] = 0.90318578f;
    data->d[5] = 0.46542743f;
    data->d[6] = -0.71896750f;
    data->d[7] = 0.45641151f;
    data->d[8] = 0.53558874f;
    data->d[9] = 0.82477534f;
    data->d[10] = 0.72069168f;
    data->d[11] = -0.05003558f;
    data->d[12] = -0.83654791f;
    data->d[13] = -1.11656642f;
    data->d[14] = -0.31712630f;
    data->d[15] = 0.29742691f;
    data->d[16] = 0.36025840f;
    data->d[17] = -0.74662429f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(12, (FireStarterOpcode)2, 8);
    code->SetOperation(13, (FireStarterOpcode)2, 1);
    ...
    code->SetOperation(22, (FireStarterOpcode)2, 3);
    code->SetOperation(23, (FireStarterOpcode)2, 14);
    ...
    code->SetOperation(28, (FireStarterOpcode)1, 11);
    code->SetOperation(29, (FireStarterOpcode)0, 7);
    code->SetOperation(30, (FireStarterOpcode)2, 16);
    code->SetOperation(31, (FireStarterOpcode)2, 17);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_id = 0;
    state.m_test = 0;
    state.m_seed = 2490180913247823351;
    state.m_optimize_pass = 0;
    state.m_bestResult = 0.86073077f;
