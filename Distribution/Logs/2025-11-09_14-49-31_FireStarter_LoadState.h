...
// Run date: 11/09/25 14:49:31 Pacific Standard Time
// Run duration = 442.854098 seconds
// Run test = 0
// Run generation = 2
// Run evolution = 0
// Run precision  = 2.84031248
// Run max result = 0.94706857
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
{
    *(result->MaxResult()) = 0.94706857f;
    *(result->EvolveAge1()) = 2;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -2.16849375f;
    data->d[1] = -2.30804825f;
    data->d[2] = -0.63499451f;
    data->d[3] = -2.29046249f;
    data->d[4] = 0.16851151f;
    data->d[5] = 1.49332583f;
    data->d[6] = -0.35760868f;
    data->d[7] = -1.38707995f;
    data->d[8] = 0.37589213f;
    data->d[9] = -0.96423990f;
    data->d[10] = -1.25624764f;
    data->d[11] = 0.89956045f;
    data->d[12] = -0.31619671f;
    data->d[13] = 1.20414877f;
    data->d[14] = -2.49681520f;
    data->d[15] = -0.41937158f;
    data->d[16] = -1.23367059f;
    data->d[17] = -2.47535682f;
    data->d[18] = 1.51110673f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.94706857f;
