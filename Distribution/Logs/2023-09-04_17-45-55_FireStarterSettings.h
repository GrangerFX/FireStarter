...
#define FIRESTARTER_EVOLVE_MINSCALE  1.0f // The minimum result scale of the first result
...
#define FIRESTARTER_REVOLVE_SEEDS           64
#define FIRESTARTER_REVOLVE_TESTS           16
#define FIRESTARTER_REVOLVE_UNITS           2
#define FIRESTARTER_REVOLVE_PROCESSES       2
...
#define FIRESTARTER_EVOLVE_PROCESSES        4
