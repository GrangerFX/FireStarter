...
#define FIRESTARTER_EVOLVE_TEST     0           // Evolve a single solution as quickly as possible.
//#define FIRESTARTER_EVOLVE_TEST     1          // Individual states evolving for a set number of generations.
//#define FIRESTARTER_EVOLVE_TEST     2          // Batches of states all evolving a list of previous states.

#if FIRESTARTER_EVOLVE_TEST == 1                // Individual states evolving for a set number of generations.
...
#elif FIRESTARTER_EVOLVE_TEST == 2              // Batches of states all evolving a list of previous states.
#define FIRESTARTER_EVOLVE_NEW      0
#if FIRESTARTER_EVOLVE_NEW
#define FIRESTARTER_EVOLVE_RANDOM   0
#define FIRESTARTER_EVOLVE_WEIGHT0  0.25f
#define FIRESTARTER_EVOLVE_WEIGHT1  1.0f
#else
#define FIRESTARTER_EVOLVE_RANDOM   0
#define FIRESTARTER_EVOLVE_WEIGHT0  0.025f
#define FIRESTARTER_EVOLVE_WEIGHT1  0.25f
#endif
#else                                           // Evolve a single solution as quickly as possible.
#define FIRESTARTER_EVOLVE_NEW      1
#define FIRESTARTER_EVOLVE_RANDOM   0
#define FIRESTARTER_EVOLVE_WEIGHT0  1.0f
#define FIRESTARTER_EVOLVE_WEIGHT1  0.0f
#endif
...
#if FIRESTARTER_EVOLVE_TEST == 1
#define FIRESTARTER_EVOLVE_TESTS            256
#define FIRESTARTER_EVOLVE_STREAMS          8
#define FIRESTARTER_EVOLVE_UNITS            1
#define FIRESTARTER_EVOLVE_STATES           1
#define FIRESTARTER_EVOLVE_GENERATIONS      128
...
#define FIRESTARTER_EVOLVE_ATTEMPTS         0
...
#elif FIRESTARTER_EVOLVE_TEST == 2
...
#define FIRESTARTER_EVOLVE_OPTIMIZE         8
#else
#define FIRESTARTER_EVOLVE_TESTS            8
#define FIRESTARTER_EVOLVE_STREAMS          4
#define FIRESTARTER_EVOLVE_UNITS            4
    ...
    inline FireStarterSettings(unsigned int evolveMode = 0)
    {
        ...
        switch (m_mode) {
            ...
            case FIRESTARTER_EVOLVE:
                ...
                m_streams =       FIRESTARTER_EVOLVE_STREAMS;
