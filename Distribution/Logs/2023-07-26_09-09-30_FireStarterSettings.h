...
#define FIRESTARTER_EVOLVE_RANDOM   1  // Set to 1 to randomize instructions instead of crossover
#define FIRESTARTER_EVOLVE_INIT     1  // Set to 1 to reset the data for each evolution.

#define FIRESTARTER_EVOLVE_MODE_COPY             0
#define FIRESTARTER_EVOLVE_MODE_CROSSOVER_FIRST  1
#define FIRESTARTER_EVOLVE_MODE_CROSSOVER_LAST   2
#define FIRESTARTER_EVOLVE_MODE_CROSSOVER_MIDDLE 3
#define FIRESTARTER_EVOLVE_MODE_CROSSOVER_WRAP   4
#define FIRESTARTER_EVOLVE_MODE_CROSSOVER_RANDOM 5
#define FIRESTARTER_EVOLVE_MODE FIRESTARTER_EVOLVE_MODE_CROSSOVER_RANDOM
...
#define FIRESTARTER_TEVOLVE  5
#define FIRESTARTER_REVOLVE  6
#define FIRESTARTER_EVOLVE   7
#define FIRESTARTER_OPTIMIZE 8
...
#define FIRESTARTER_TEVOLVE_PROCESSES       0
#define FIRESTARTER_TEVOLVE_POPULATION      4352 * 64
#define FIRESTARTER_TEVOLVE_ITERATIONS      64
#define FIRESTARTER_TEVOLVE_CANDIDATES      16
#define FIRESTARTER_TEVOLVE_GENERATIONS     100
#define FIRESTARTER_TEVOLVE_PRECISION       0
#define FIRESTARTER_TEVOLVE_ATTEMPTS        64
#define FIRESTARTER_TEVOLVE_SCALE           0.1f
