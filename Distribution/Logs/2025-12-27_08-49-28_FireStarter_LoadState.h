...
// Run date: 12/27/25 08:49:28 Pacific Standard Time
// Run duration = 539.199305 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.77103734
...
{
    *(result->MaxResult()) = 0.77103734f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.63039345f;
    data->d[1] = 0.63140285f;
    data->d[2] = 0.97232741f;
    data->d[3] = -0.09256361f;
    data->d[4] = 0.63303441f;
    data->d[5] = 0.99126536f;
    data->d[6] = 2.09353971f;
    data->d[7] = 0.61191076f;
    data->d[8] = -0.76249778f;
    data->d[9] = 0.65774000f;
    data->d[10] = -0.62300432f;
    data->d[11] = 0.39668348f;
    data->d[12] = -0.12812544f;
    data->d[13] = 1.08490479f;
    data->d[14] = 0.65579337f;
    data->d[15] = -0.69573641f;
    data->d[16] = 0.53639263f;
    data->d[17] = -0.59365648f;
    data->d[18] = 0.65721703f;
    data->d[19] = -0.55719149f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(24, (FireStarterOpcode)1, 2);
    code->SetOperation(25, (FireStarterOpcode)2, 4);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.77103734f;
