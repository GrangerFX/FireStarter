...
// Run date: 09/28/25 11:12:19 Pacific Daylight Time
// Run duration = 48.356194 seconds
// Run test = 0
// Run generation = 8
// Run evolution = 0
// Run precision  = 10.00000000
// Run max result = 0.65346295
// Run variations = 1
// Run instructions = 32
// Run registers = 30
// Run opcodes = 3
...
{
    *(result->MaxResult()) = 0.65346295f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 52;
    FireStarterData *data = result->Data();
    data->d[0] = -0.70796961f;
    data->d[1] = -1.24591744f;
    data->d[2] = 2.17133617f;
    data->d[3] = 1.07450223f;
    data->d[4] = 0.01229506f;
    data->d[5] = 2.10505438f;
    data->d[6] = -1.55513334f;
    data->d[7] = 1.56614637f;
    data->d[8] = -0.16661078f;
    data->d[9] = 1.77942765f;
    data->d[10] = 0.05368017f;
    data->d[11] = 2.13813162f;
    data->d[12] = -0.44532651f;
    data->d[13] = -0.05209669f;
    data->d[14] = 2.38225865f;
    data->d[15] = -1.51757526f;
    data->d[16] = 0.09374606f;
    data->d[17] = -0.82280630f;
    data->d[18] = 0.32963231f;
    data->d[19] = -1.38044202f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(11, (FireStarterOpcode)1, 0);
    ...
    code->SetOperation(22, (FireStarterOpcode)2, 13);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.65346295f;
