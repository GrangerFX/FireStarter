...
#define FIRESTARTER_START_TEST      11          // The starting test index.
...
#define FIRESTARTER_OPTIMIZE_CPU    3           // Optimize a previously CPU evolved state.
...
#define FIRESTARTER_POPULATION      8704 * FIRESTARTER_WARP_THREADS
...
#define FIRESTARTER_START_SCALE     2.0f
#define FIRESTARTER_START_RESULT    10.0f
#define FIRESTARTER_OPTIMIZE_PASSES 4
...
#if FIRESTARTER_MODE == FIRESTARTER_OPTIMIZE_CPU
#define FIRESTARTER_VARIATIONS      3
#define FIRESTARTER_STREAMS         1
#define FIRESTARTER_UNITS           1
...
#define FIRESTARTER_STATES          1
#define FIRESTARTER_GENERATIONS     0
#define FIRESTARTER_POPULATION      8192    // One member per warp for GPU evolution
#define FIRESTARTER_ITERATIONS      64
#define FIRESTARTER_CANDIDATES      16
#define FIRESTARTER_PASSES          500
#define FIRESTARTER_ATTEMPTS        0
...
#if FIRESTARTER_MODE == FIRESTARTER_OPTIMIZE_GPU
#define FIRESTARTER_VARIATIONS      1
#define FIRESTARTER_STREAMS         1
#define FIRESTARTER_UNITS           1
#define FIRESTARTER_STATES          1
#define FIRESTARTER_GENERATIONS     0
#define FIRESTARTER_POPULATION      8192 * FIRESTARTER_WARP_THREADS   // 1 member per thread for GPU optimization
#define FIRESTARTER_ITERATIONS      64
#define FIRESTARTER_CANDIDATES      16
#define FIRESTARTER_PASSES          100
#define FIRESTARTER_ATTEMPTS        0
