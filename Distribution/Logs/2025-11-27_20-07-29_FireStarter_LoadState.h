...
// Run date: 11/27/25 20:07:29 Pacific Standard Time
// Run duration = 7070.095250 seconds
// Run test = 0
// Run generation = 10
// Run evolution = 0
// Run max result = 0.84307379
...
{
    *(result->MaxResult()) = 0.84307379f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = 0.03024309f;
    data->d[1] = -1.68628490f;
    data->d[2] = 1.97368562f;
    data->d[3] = 0.65136719f;
    data->d[4] = 1.31740022f;
    data->d[5] = 0.32855299f;
    data->d[6] = -1.75528789f;
    data->d[7] = -0.51342744f;
    data->d[8] = -1.52033877f;
    data->d[9] = -1.85572720f;
    data->d[10] = -10.81688118f;
    data->d[11] = -0.86881995f;
    data->d[12] = -0.88412923f;
    data->d[13] = 0.22137272f;
    data->d[14] = 0.23034726f;
    data->d[15] = 0.69916779f;
    data->d[16] = 0.72428644f;
    data->d[17] = -1.25570428f;
    data->d[18] = 0.40216294f;
    data->d[19] = -0.15681975f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(18, (FireStarterOpcode)2, 5);
    ...
    code->SetOperation(23, (FireStarterOpcode)2, 0);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.84307379f;
