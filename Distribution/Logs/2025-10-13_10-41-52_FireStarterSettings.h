...
#define MONEYMAKER_HISTORY          (MONEYMAKER_WARMUP + MONEYMAKER_TRADING)   // Days of stock history data
#define MONEYMAKER_STOCKS           1           // Stocks with history data
#define MONEYMAKER_FUNDS            1000.0f     // Starting trading funds
#define MONEYMAKER_TESTER           1           // Evaluates each trade on the GPU and CPU.
...
#define FIRESTARTER_MONEYMAKER_GENERATIONS      2
