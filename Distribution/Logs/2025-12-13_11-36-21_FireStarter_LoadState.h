...
// Run date: 12/13/25 11:36:21 Pacific Standard Time
// Run duration = 148.004447 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.87553018
...
{
    *(result->MaxResult()) = 0.87553018f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.68517101f;
    data->d[1] = -0.58930427f;
    data->d[2] = -0.68512267f;
    data->d[3] = -0.49565837f;
    data->d[4] = -0.33962363f;
    data->d[5] = -2.06152868f;
    data->d[6] = 0.93160605f;
    data->d[7] = 0.24058668f;
    data->d[8] = -0.42012480f;
    data->d[9] = 0.91705418f;
    data->d[10] = -0.94822502f;
    data->d[11] = 1.59403801f;
    data->d[12] = 0.61018819f;
    data->d[13] = -0.45380163f;
    data->d[14] = -0.99659741f;
    data->d[15] = 0.71396226f;
    data->d[16] = -0.96316397f;
    data->d[17] = -0.90368736f;
    data->d[18] = 0.89540970f;
    data->d[19] = -0.69913012f;
    data->d[20] = -0.31786853f;
    data->d[21] = 0.73970389f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(19, (FireStarterOpcode)2, 17);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.87553018f;
