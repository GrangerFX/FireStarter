...
#define FIRESTARTER_START_TEST      4          // The starting test index.
#define FIRESTARTER_STREAMS         1          // Maximum number of streams

#define FIRESTARTER_EVOLVE_BEST     0.25       // The percent of best evolved states.
#define FIRESTARTER_EVOLVE_SKIP     0 // 1.25       // The percent used to skip variation generations.
...
#define FIRESTARTER_RANDOM_PASSES           1
...
#define FIRESTARTER_EVOLVE_PASSES           5
