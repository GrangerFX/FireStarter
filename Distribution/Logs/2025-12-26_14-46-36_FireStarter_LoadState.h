...
// Run date: 12/26/25 14:46:36 Pacific Standard Time
// Run duration = 1042.724778 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.81852067
...
{
    *(result->MaxResult()) = 0.81852067f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.42951384f;
    data->d[1] = 0.50602973f;
    data->d[2] = 0.91471523f;
    data->d[3] = 0.11713279f;
    data->d[4] = 0.74238759f;
    data->d[5] = 0.61638826f;
    data->d[6] = -0.70110857f;
    data->d[7] = -0.95711744f;
    data->d[8] = 0.03764150f;
    data->d[9] = 0.90254527f;
    data->d[10] = -0.48481247f;
    data->d[11] = 0.88654274f;
    data->d[12] = -0.92268783f;
    data->d[13] = 0.78312552f;
    data->d[14] = -1.42212427f;
    data->d[15] = -1.24350119f;
    data->d[16] = 2.05671215f;
    data->d[17] = -0.31852683f;
    data->d[18] = 0.32509878f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(5, (FireStarterOpcode)2, 2);
    ...
    code->SetOperation(13, (FireStarterOpcode)2, 4);
    ...
    code->SetOperation(27, (FireStarterOpcode)2, 3);
    code->SetOperation(28, (FireStarterOpcode)2, 12);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.81852067f;
