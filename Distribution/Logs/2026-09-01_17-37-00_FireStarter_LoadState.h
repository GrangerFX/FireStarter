...
// Run date: 09/01/26 17:37:00 Pacific Daylight Time
// Run duration = 1797.930662 seconds
// Run test = 0
// Run generation = 0
// Run evolution = 0
// Run max result = 0.99958283
...
{
    *(result->MaxResult()) = 0.99958283f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.55287898f;
    data->d[1] = 0.06192041f;
    data->d[2] = 0.37642914f;
    data->d[3] = -0.91853315f;
    data->d[4] = -0.25407580f;
    data->d[5] = -0.20665990f;
    data->d[6] = 0.45952836f;
    data->d[7] = -0.91813403f;
    data->d[8] = 0.19233148f;
    data->d[9] = -0.17160136f;
    data->d[10] = -0.27292985f;
    data->d[11] = -0.82825941f;
    data->d[12] = -0.96129811f;
    data->d[13] = -0.94543034f;
    data->d[14] = -0.64303404f;
    data->d[15] = 0.04153292f;
    data->d[16] = -0.80991620f;
    data->d[17] = -0.17490253f;
    data->d[18] = 0.93536550f;
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.99958283f;
