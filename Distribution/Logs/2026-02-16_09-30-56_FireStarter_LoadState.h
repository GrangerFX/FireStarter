...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(11, (FireStarterOpcode)2, 2);
    code->SetOperation(12, (FireStarterOpcode)2, 1);
    ...
    code->SetOperation(17, (FireStarterOpcode)3, 11);
    code->SetOperation(18, (FireStarterOpcode)2, 15);
    code->SetOperation(19, (FireStarterOpcode)3, 16);
    code->SetOperation(20, (FireStarterOpcode)0, 7);
    code->SetOperation(21, (FireStarterOpcode)3, 17);
    code->SetOperation(22, (FireStarterOpcode)2, 18);
    code->SetOperation(23, (FireStarterOpcode)0, 19);
    code->SetOperation(24, (FireStarterOpcode)1, 20);
    ...
    code->SetOperation(28, (FireStarterOpcode)2, 6);
    code->SetOperation(29, (FireStarterOpcode)3, 22);
    code->SetOperation(30, (FireStarterOpcode)0, 18);
    code->SetOperation(31, (FireStarterOpcode)3, 11);
