...
// Run date: 12/01/25 09:19:22 Pacific Standard Time
// Run duration = 2099.390768 seconds
// Run test = 0
// Run generation = 3
// Run evolution = 0
// Run max result = 0.82725030
...
{
    *(result->MaxResult()) = 0.82725030f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -2.01189399f;
    data->d[1] = -0.28171933f;
    data->d[2] = 1.46263707f;
    data->d[3] = 1.68258846f;
    data->d[4] = -2.26101613f;
    data->d[5] = -2.01314235f;
    data->d[6] = -1.84693432f;
    data->d[7] = 2.46052313f;
    data->d[8] = -1.36747932f;
    data->d[9] = -2.49520135f;
    data->d[10] = 1.87888777f;
    data->d[11] = 0.57465881f;
    data->d[12] = -0.02815675f;
    data->d[13] = 1.03318071f;
    data->d[14] = -0.46874538f;
    data->d[15] = 0.53245908f;
    data->d[16] = 1.79260230f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(21, (FireStarterOpcode)2, 9);
    code->SetOperation(22, (FireStarterOpcode)1, 1);
    code->SetOperation(23, (FireStarterOpcode)1, 10);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.82725030f;
