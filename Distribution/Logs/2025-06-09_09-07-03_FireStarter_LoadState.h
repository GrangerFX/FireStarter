...
// Run date: 06/09/25 09:07:03 Pacific Daylight Time
// Run duration = 2.282475 seconds
// Run test = 0
// Run generation = 220
// Run evolution = 0
// Run precision  = 2.20769286
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.00000095f;
    state.m_oldResult = 0.00000101f;
