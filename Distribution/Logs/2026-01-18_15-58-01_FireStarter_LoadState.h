...
// Run date: 01/18/26 15:58:01 Pacific Standard Time
// Run duration = 910.344214 seconds
// Run test = 0
// Run generation = 1
// Run evolution = 0
// Run max result = 0.99737412
...
{
    *(result->MaxResult()) = 0.99737412f;
    *(result->EvolveAge1()) = 1;
    *(result->EvolveAge2()) = 0;
    FireStarterData *data = result->Data();
    data->d[0] = -0.21665801f;
    data->d[1] = -0.85929120f;
    data->d[2] = -0.86877954f;
    data->d[3] = 0.97851211f;
    data->d[4] = 0.27541518f;
    data->d[5] = -0.91451037f;
    data->d[6] = 0.23616336f;
    data->d[7] = -0.93380570f;
    data->d[8] = 0.67427778f;
    data->d[9] = -0.38648567f;
    data->d[10] = 0.57192904f;
    data->d[11] = 0.17577568f;
    data->d[12] = 0.42600748f;
    data->d[13] = 0.93310589f;
    data->d[14] = -0.15990040f;
    data->d[15] = 0.98968899f;
    data->d[16] = -0.01308106f;
...
inline unsigned int LoadCode(FireStarterCode* code)
{
    ...
    code->SetOperation(8, (FireStarterOpcode)0, 1);
    ...
    code->SetOperation(15, (FireStarterOpcode)1, 6);
    code->SetOperation(16, (FireStarterOpcode)1, 2);
    ...
    code->SetOperation(28, (FireStarterOpcode)2, 15);
    code->SetOperation(29, (FireStarterOpcode)1, 16);
    code->SetOperation(30, (FireStarterOpcode)1, 15);
    code->SetOperation(31, (FireStarterOpcode)1, 11);
...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_bestResult = 0.99737412f;
