...
#define FIRESTARTER_EVOLVE_RESULTS  1           // Copy all of the evolve and optimize data to the host.
...
#define FIRESTARTER_EVOLVE_NEW_GENERATIONS      1000
#define FIRESTARTER_EVOLVE_NEW_POPULATION       65536
#define FIRESTARTER_EVOLVE_NEW_PASSES           1
#define FIRESTARTER_EVOLVE_NEW_ITERATIONS       16
#define FIRESTARTER_EVOLVE_NEW_SAMPLES          4096
