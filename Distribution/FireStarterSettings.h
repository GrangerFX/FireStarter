...
#define FIRESTARTER_SAVE_LOADSTATE  1           // Save FireStarter_LoadState when the best state is updated.
...
#define FIRESTARTER_RANDOM_TARGET               0.0000008f
...
#define FIRESTARTER_EVOLVE_CPU_TARGET           0.0000008f
...
#define FIRESTARTER_OPTIMIZE_CPU_TARGET         0.0000008f
...
#define FIRESTARTER_OPTIMIZE_CPU_OPTIMIZE       20

#define FIRESTARTER_EVOLVE_GPU_TARGET           0.0000008f
...
#define FIRESTARTER_OPTIMIZE_GPU_TARGET         0.0000008f
...
#define FIRESTARTER_OPTIMIZE_GPU_POPULATION     8704 * FIRESTARTER_WARP_THREADS   // 1 member per thread for GPU optimization
...
#define FIRESTARTER_OPTIMIZE_GPU_ATTEMPTS       32
...
#define FIRESTARTER_OPTIMIZE_GPU_OPTIMIZE       20
...
#define FIRESTARTER_SPEED_TEST_POPULATION       8704 * FIRESTARTER_WARP_THREADS   // 1 member per thread for GPU optimization
...
#define FIRESTARTER_SPEED_TEST_ATTEMPTS         32
#define FIRESTARTER_SPEED_TEST_SCALE            0.1f
#define FIRESTARTER_SPEED_TEST_START_SCALE      2.0f
#define FIRESTARTER_SPEED_TEST_START_RESULT     10.0f
#define FIRESTARTER_SPEED_TEST_OPTIMIZE         10

#if FIRESTARTER_MODE == FIRESTARTER_RANDOM
#define FIRESTARTER_TARGET          FIRESTARTER_RANDOM_TARGET
...
#define FIRESTARTER_TARGET          FIRESTARTER_EVOLVE_CPU_TARGET
...
#define FIRESTARTER_TARGET          FIRESTARTER_OPTIMIZE_CPU_TARGET
...
#define FIRESTARTER_TARGET          FIRESTARTER_EVOLVE_GPU_TARGET
...
#define FIRESTARTER_TARGET          FIRESTARTER_OPTIMIZE_GPU_TARGET
...
#elif  FIRESTARTER_MODE == FIRESTARTER_SPEED_TEST
#define FIRESTARTER_TARGET          FIRESTARTER_SPEED_TEST_TARGET
#define FIRESTARTER_STREAMS         FIRESTARTER_SPEED_TEST_STREAMS
#define FIRESTARTER_UNITS           FIRESTARTER_SPEED_TEST_UNITS
#define FIRESTARTER_STATES          FIRESTARTER_SPEED_TEST_STATES
#define FIRESTARTER_GENERATIONS     FIRESTARTER_SPEED_TEST_GENERATIONS
#define FIRESTARTER_POPULATION      FIRESTARTER_SPEED_TEST_POPULATION
#define FIRESTARTER_ITERATIONS      FIRESTARTER_SPEED_TEST_ITERATIONS
#define FIRESTARTER_CANDIDATES      FIRESTARTER_SPEED_TEST_CANDIDATES
#define FIRESTARTER_PASSES          FIRESTARTER_SPEED_TEST_PASSES
#define FIRESTARTER_ATTEMPTS        FIRESTARTER_SPEED_TEST_ATTEMPTS
#define FIRESTARTER_SCALE           FIRESTARTER_SPEED_TEST_SCALE
#define FIRESTARTER_START_SCALE     FIRESTARTER_SPEED_TEST_START_SCALE
#define FIRESTARTER_START_RESULT    FIRESTARTER_SPEED_TEST_START_RESULT
#define FIRESTARTER_OPTIMIZE        FIRESTARTER_SPEED_TEST_OPTIMIZE
#else
#define FIRESTARTER_TARGET          0.0f
...
public:
    ...
    float m_target =                FIRESTARTER_TARGET;
