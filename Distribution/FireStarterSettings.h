...
#define FIRESTARTER_MODE FIRESTARTER_MODES      // Must be defined by either the project or the CUDA kernel. If not, it ends up as FIRESTARTER_MODES with all zeros for the values.
#endif
...
#define FIRESTARTER_RANDOM_OPTIMIZE             1
...
#define FIRESTARTER_EVOLVE_NEW_POPULATION       32768
...
#define FIRESTARTER_EVOLVE_OPTIMIZE_POPULATION  65536
#define FIRESTARTER_EVOLVE_OPTIMIZE_PASSES      384
#define FIRESTARTER_EVOLVE_OPTIMIZE_ITERATIONS  FIRESTARTER_ITERATIONS
#define FIRESTARTER_EVOLVE_OPTIMIZE_SAMPLES     FIRESTARTER_SAMPLES
#define FIRESTARTER_EVOLVE_OPTIMIZE_OPTIMIZE    1
...
#define FIRESTARTER_EVOLVE_SINSIM_POPULATION    32768
#define FIRESTARTER_EVOLVE_SINSIM_PASSES        64
#define FIRESTARTER_EVOLVE_SINSIM_ITERATIONS    FIRESTARTER_ITERATIONS
#define FIRESTARTER_EVOLVE_SINSIM_SAMPLES       256
...
#define FIRESTARTER_MONEYOPTIMIZE_ITERATIONS    FIRESTARTER_ITERATIONS
#define FIRESTARTER_MONEYOPTIMIZE_SAMPLES       FIRESTARTER_SAMPLES
...
typedef enum : unsigned short {
    ...
    Operation_load,          // n = data[d];
} FireStarterOpcode;

#if FIRESTARTER_FIRSTLIGHT
// The original instructions from FireStarter First Light.
...
//  Operation_max,           // n = MAX(n, data[d]);
    Operation_store,         // data[d] = n;
//  Operation_load,          // data[d] = n;
};
#elif (FIRESTARTER_MODE == FIRESTARTER_MONEYMAKER) || (FIRESTARTER_MODE == FIRESTARTER_MONEYOPTIMIZE)
// MoneyMaker continuously updates the data so a spcial instruction set is needed.
const FireStarterOpcode fireStarterOpcodes[] = {
    Operation_multiply,      // n *= data[d];
    Operation_add,           // n += data[d];
    Operation_store,         // data[d] = n;
...
// Duplicate opcodes weight one operation more and allows the evolution to find better solutions faster.
const FireStarterOpcode fireStarterOpcodes[] = {
    Operation_data_multiply, // n = data[d] *= n;
    Operation_data_multiply, // n = data[d] *= n;
    Operation_data_add,      // n = data[d] += n;
    ...
    static inline const char* Mode(unsigned int mode)
    {
        switch (mode) {
            ...
            case FIRESTARTER_EVOLVE_OPTIMIZE:
                return "FIRESTARTER_EVOLVE_OPTIMIZE";
    ...
    {   
        ...
        switch (m_mode) {
            ...
            case FIRESTARTER_EVOLVE_OPTIMIZE:
                ...
                m_population =  FIRESTARTER_EVOLVE_OPTIMIZE_POPULATION;
                m_passes =      FIRESTARTER_EVOLVE_OPTIMIZE_PASSES;
                m_iterations =  FIRESTARTER_EVOLVE_OPTIMIZE_ITERATIONS;
                m_samples =     FIRESTARTER_EVOLVE_OPTIMIZE_SAMPLES;
                m_optimize =    FIRESTARTER_EVOLVE_OPTIMIZE_OPTIMIZE;
                m_tests =       FIRESTARTER_EVOLVE_OPTIMIZE_TESTS;
            ...
            case FIRESTARTER_MONEYOPTIMIZE:
                ...
                m_population =  FIRESTARTER_MONEYOPTIMIZE_POPULATION;
                m_passes =      FIRESTARTER_MONEYOPTIMIZE_PASSES;
                m_iterations =  FIRESTARTER_MONEYOPTIMIZE_ITERATIONS;
                m_samples =     FIRESTARTER_MONEYOPTIMIZE_SAMPLES;
                m_optimize =    FIRESTARTER_MONEYOPTIMIZE_OPTIMIZE;
                m_tests =       FIRESTARTER_MONEYOPTIMIZE_TESTS;
