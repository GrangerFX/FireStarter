...
#define FIRESTARTER_INSTRUCTIONS 32 // Must be a power of 2 for ReverseBits to work
...
#define FIRESTARTER_TEST_TESTS              1
...
#define FIRESTARTER_TEST_ATTEMPTS           128
...
#define FIRESTARTER_REVOLVE_ATTEMPTS        16
