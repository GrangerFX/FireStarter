...
GPU_FUNCTION float Evaluate(FireStarter2Data data, float n)
{
    float result = 0.0f;
    data.d[0] = n;
    data.d[4] = data.d[4] + data.d[5] * data.d[0];
    data.d[5] = data.d[4] + data.d[5] * data.d[4];
    data.d[0] = data.d[3] + data.d[2] * data.d[0];
    data.d[2] = data.d[4] + data.d[2] * data.d[5];
    data.d[2] = data.d[0] + data.d[5] * data.d[2];
    data.d[4] = data.d[1] + data.d[4] * data.d[0];
    data.d[3] = data.d[0] + data.d[4] * data.d[4];
    data.d[1] = data.d[1] + data.d[1] * data.d[1];
    data.d[4] = data.d[3] + data.d[5] * data.d[3];
    data.d[1] = data.d[1] + data.d[2] * data.d[3];
    data.d[5] = data.d[3] + data.d[5] * data.d[2];
    data.d[4] = data.d[3] + data.d[1] * data.d[1];
    result = data.d[4];
