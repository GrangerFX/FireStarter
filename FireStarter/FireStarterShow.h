...
public:
	...
	void ShowStatus(const FireStarterState& bestState, const FireStarterState& state, unsigned long long generation, unsigned long long age, double runTime, double generationTime, double oldResult, double newResult, double bestError, bool sync = false);
