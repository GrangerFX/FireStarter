...
public:
    static void TestMoneyMaker(const FireStarterState& state, const MoneyMakerStock& stock, unsigned int numValue, float* tradingPercent, float* validationPercent = nullptr);
