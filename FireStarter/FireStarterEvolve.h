...
public:
	...
	bool EvolveStates(const std::vector<FireStarterState>& allStates, std::atomic<unsigned long long>& stateIndex, TestedInstructions* testedInstructions, unsigned long long generation, bool sync = false);
