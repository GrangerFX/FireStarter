...
inline void LoadState(FireStarterState& state)
{
    ...
    state.m_result0.data.d[0] = 0.147631f;
    state.m_result0.data.d[1] = -0.059146f;
    state.m_result0.data.d[2] = -2.231767f;
    state.m_result0.data.d[3] = 1.304104f;
    state.m_result0.data.d[4] = 0.570817f;
    state.m_result0.data.d[5] = 0.536862f;
    state.m_result0.data.d[6] = -0.960582f;
    state.m_result0.data.d[7] = 0.604844f;
    state.m_result0.data.d[8] = 0.810656f;
    state.m_result0.data.d[9] = -0.287727f;
    state.m_result0.data.d[10] = -0.790731f;
    state.m_result0.data.d[11] = -1.196499f;
    state.m_result0.data.d[12] = -1.875646f;
    state.m_result0.data.d[13] = 0.936001f;
    state.m_result0.data.d[14] = 0.779106f;
    state.m_result0.data.d[15] = -0.599340f;
    state.m_result0.data.d[16] = 0.607282f;
    state.m_result0.data.d[17] = -0.180131f;
    state.m_result0.data.d[18] = 1.823968f;
    state.m_result0.data.d[19] = -0.073667f;
    state.m_result0.data.d[20] = 0.749525f;
    ...
    state.m_result0.result = 0.000218f;

    state.m_result1.data.d[0] = 0.868628f;
    state.m_result1.data.d[1] = -0.277484f;
    state.m_result1.data.d[2] = -0.965830f;
    state.m_result1.data.d[3] = 1.389340f;
    state.m_result1.data.d[4] = -0.095932f;
    state.m_result1.data.d[5] = 0.571882f;
    state.m_result1.data.d[6] = -1.401554f;
    state.m_result1.data.d[7] = 0.763038f;
    state.m_result1.data.d[8] = 0.204349f;
    state.m_result1.data.d[9] = 1.885065f;
    state.m_result1.data.d[10] = -0.390096f;
    state.m_result1.data.d[11] = -1.517491f;
    state.m_result1.data.d[12] = 0.329436f;
    state.m_result1.data.d[13] = 0.289943f;
    state.m_result1.data.d[14] = -0.813003f;
    state.m_result1.data.d[15] = 0.129184f;
    state.m_result1.data.d[16] = 0.408802f;
    state.m_result1.data.d[17] = -1.188487f;
    state.m_result1.data.d[18] = -0.549903f;
    state.m_result1.data.d[19] = -0.380334f;
    state.m_result1.data.d[20] = 0.749525f;
    ...
    state.m_result1.result = 0.000394f;

    state.m_processingTime = 0.715609;
    state.m_maxResult = 0.000394f;
} // LoadState
