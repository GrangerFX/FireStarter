...
{
    state.m_result.data[0].d[0] = -1.016569f;
    state.m_result.data[0].d[1] = -4.400327f;
    state.m_result.data[0].d[2] = 0.772707f;
    state.m_result.data[0].d[3] = 1.250116f;
    state.m_result.data[0].d[4] = -0.584759f;
    state.m_result.data[0].d[5] = -0.246601f;
    state.m_result.data[0].d[6] = -0.050547f;
    state.m_result.data[0].d[7] = -0.478507f;
    state.m_result.data[0].d[8] = 0.185830f;
    state.m_result.data[0].d[9] = 1.608996f;
    state.m_result.data[0].d[10] = 0.423133f;
    state.m_result.data[0].d[11] = -2.108046f;
    state.m_result.data[0].d[12] = 3.381892f;
    state.m_result.data[0].d[13] = -0.155559f;
    state.m_result.data[0].d[14] = 1.004493f;
    state.m_result.data[0].d[15] = -0.723485f;
    state.m_result.data[0].d[16] = 0.523664f;
    state.m_result.data[0].d[17] = 1.307623f;
    state.m_result.data[0].d[18] = 0.832523f;
    state.m_result.data[0].d[19] = -0.385380f;
    state.m_result.data[0].d[20] = -0.026978f;
    ...
    state.m_result.minResult[0] = 0.000033f;

    state.m_result.data[1].d[0] = -1.115419f;
    state.m_result.data[1].d[1] = -0.200588f;
    state.m_result.data[1].d[2] = 0.381481f;
    state.m_result.data[1].d[3] = -1.015813f;
    state.m_result.data[1].d[4] = -1.009828f;
    state.m_result.data[1].d[5] = -0.436326f;
    state.m_result.data[1].d[6] = -0.121187f;
    state.m_result.data[1].d[7] = 0.277050f;
    state.m_result.data[1].d[8] = 0.575679f;
    state.m_result.data[1].d[9] = -0.291005f;
    state.m_result.data[1].d[10] = -2.275828f;
    state.m_result.data[1].d[11] = 0.153617f;
    state.m_result.data[1].d[12] = -1.299448f;
    state.m_result.data[1].d[13] = 0.499080f;
    state.m_result.data[1].d[14] = -1.072709f;
    state.m_result.data[1].d[15] = 0.626377f;
    state.m_result.data[1].d[16] = 0.183101f;
    state.m_result.data[1].d[17] = 0.900468f;
    state.m_result.data[1].d[18] = 1.326055f;
    state.m_result.data[1].d[19] = 0.879828f;
    state.m_result.data[1].d[20] = 0.484174f;
    ...
    state.m_result.minResult[1] = 0.000040f;

    state.m_result.data[2].d[0] = -0.583518f;
    state.m_result.data[2].d[1] = 0.494478f;
    state.m_result.data[2].d[2] = -0.554139f;
    state.m_result.data[2].d[3] = -0.201655f;
    state.m_result.data[2].d[4] = 0.319503f;
    state.m_result.data[2].d[5] = 0.780921f;
    state.m_result.data[2].d[6] = 0.040328f;
    state.m_result.data[2].d[7] = -0.355637f;
    state.m_result.data[2].d[8] = -0.350085f;
    state.m_result.data[2].d[9] = 1.065277f;
    state.m_result.data[2].d[10] = 1.120929f;
    state.m_result.data[2].d[11] = -0.317191f;
    state.m_result.data[2].d[12] = 1.884423f;
    state.m_result.data[2].d[13] = -3.163043f;
    state.m_result.data[2].d[14] = 0.238294f;
    state.m_result.data[2].d[15] = 0.437954f;
    state.m_result.data[2].d[16] = 0.046689f;
    state.m_result.data[2].d[17] = 0.783099f;
    state.m_result.data[2].d[18] = -0.468256f;
    state.m_result.data[2].d[19] = 0.386139f;
    state.m_result.data[2].d[20] = -0.090940f;
    ...
    state.m_result.minResult[2] = 0.000043f;

    state.m_result.maxResult = 0.000043f;
