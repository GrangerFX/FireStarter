...
inline void LoadSettings(FireStarterSettings& settings)
{
    ...
    settings.m_sampleMin = 0.000000;
    settings.m_sampleMax = 6.283185;
    settings.m_evolveFactor = 0.100000;
    settings.m_evolveStartFactor = 4.000000;
    settings.m_evolveStartResult = 10.000000;
